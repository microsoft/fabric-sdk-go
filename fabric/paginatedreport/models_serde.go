...
// MarshalJSON implements the json.Marshaller interface for type CreatePaginatedReportRequest.
func (c CreatePaginatedReportRequest) MarshalJSON() ([]byte, error) {
...
// UnmarshalJSON implements the json.Unmarshaller interface for type CreatePaginatedReportRequest.
func (c *CreatePaginatedReportRequest) UnmarshalJSON(data []byte) error {
...
// MarshalJSON implements the json.Marshaller interface for type UpdatePaginatedReportDefinitionRequest.
func (u UpdatePaginatedReportDefinitionRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "definition", u.Definition)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type UpdatePaginatedReportDefinitionRequest.
func (u *UpdatePaginatedReportDefinitionRequest) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
