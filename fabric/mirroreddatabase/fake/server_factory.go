...
// ServerFactory is a fake server for instances of the mirroreddatabase.ClientFactory type.
type ServerFactory struct {
	ItemsServer     ItemsServer
	MirroringServer MirroringServer
}

// ServerFactoryTransport connects instances of mirroreddatabase.ClientFactory to instances of ServerFactory.
...
// The returned ServerFactoryTransport instance is connected to an instance of mirroreddatabase.ClientFactory via the
