...
// ServerFactoryTransport connects instances of graphqlapi.ClientFactory to instances of ServerFactory.
...
// The returned ServerFactoryTransport instance is connected to an instance of graphqlapi.ClientFactory via the
