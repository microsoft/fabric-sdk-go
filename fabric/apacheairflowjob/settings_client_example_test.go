...
func ExampleSettingsClient_GetApacheAirflowJobSettingsBeta() {
	...
	res, err := clientFactory.NewSettingsClient().GetApacheAirflowJobSettingsBeta(ctx, "cfafbeb1-8037-4d0c-896e-a46fb27ff229", "5b218778-e7a5-4d73-8187-f10824047715", true, nil)
	if err != nil {
	...
	// res.AirflowEnvironmentSettingsResponse = apacheairflowjob.AirflowEnvironmentSettingsResponse{
