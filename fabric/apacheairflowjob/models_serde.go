...
// UnmarshalJSON implements the json.Unmarshaller interface for type AirflowEnvironmentSettingsRequest.
func (a *AirflowEnvironmentSettingsRequest) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", a, err)
	}
...
func (a ApacheAirflowJob) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "defaultIdentity", a.DefaultIdentity)
...
func (a *ApacheAirflowJob) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "defaultIdentity":
			a.DefaultIdentity, err = unmarshalPrincipalClassification(val)
			delete(rawMsg, key)
		case "description":
