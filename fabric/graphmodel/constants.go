...
const (
	// DefinitionFormatJSON - JSON format for the GraphModel public definition, specifically designed to support CI/CD scenarios
	// in Fabric.
	DefinitionFormatJSON DefinitionFormat = "json"
)

// PossibleGraphModelDefinitionFormatValues returns the possible values for the DefinitionFormat const type.
func PossibleGraphModelDefinitionFormatValues() []DefinitionFormat {
