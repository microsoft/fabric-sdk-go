...
// ServerFactory is a fake server for instances of the graphmodel.ClientFactory type.
type ServerFactory struct {
	BackgroundJobsServer BackgroundJobsServer
	ItemsServer          ItemsServer
}

// ServerFactoryTransport connects instances of graphmodel.ClientFactory to instances of ServerFactory.
...
// The returned ServerFactoryTransport instance is connected to an instance of graphmodel.ClientFactory via the
