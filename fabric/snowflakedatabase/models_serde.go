...
// MarshalJSON implements the json.Marshaller interface for type CreateSnowflakeDatabaseRequest.
func (c CreateSnowflakeDatabaseRequest) MarshalJSON() ([]byte, error) {
...
// UnmarshalJSON implements the json.Unmarshaller interface for type CreateSnowflakeDatabaseRequest.
func (c *CreateSnowflakeDatabaseRequest) UnmarshalJSON(data []byte) error {
...
func (c CreationPayload) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "snowflakeDatabaseName", c.SnowflakeDatabaseName)
	return json.Marshal(objectMap)
}
...
func (c *CreationPayload) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "connectionId":
			...
			delete(rawMsg, key)
		case "snowflakeDatabaseName":
			err = unpopulate(val, "SnowflakeDatabaseName", &c.SnowflakeDatabaseName)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", c, err)
...
func (p Properties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "snowflakeAccountURL", p.SnowflakeAccountURL)
	populate(objectMap, "snowflakeDatabaseName", p.SnowflakeDatabaseName)
	populate(objectMap, "snowflakeVolumePath", p.SnowflakeVolumePath)
	return json.Marshal(objectMap)
}
...
func (p *Properties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "sqlEndpointProperties":
			...
			delete(rawMsg, key)
		case "snowflakeAccountURL":
			err = unpopulate(val, "SnowflakeAccountURL", &p.SnowflakeAccountURL)
			delete(rawMsg, key)
		case "snowflakeDatabaseName":
			err = unpopulate(val, "SnowflakeDatabaseName", &p.SnowflakeDatabaseName)
			delete(rawMsg, key)
		case "snowflakeVolumePath":
			err = unpopulate(val, "SnowflakeVolumePath", &p.SnowflakeVolumePath)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", p, err)
...
// MarshalJSON implements the json.Marshaller interface for type SnowflakeDatabase.
func (s SnowflakeDatabase) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type SnowflakeDatabase.
func (s *SnowflakeDatabase) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type SnowflakeDatabases.
func (s SnowflakeDatabases) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type SnowflakeDatabases.
func (s *SnowflakeDatabases) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type UpdateSnowflakeDatabaseDefinitionRequest.
func (u UpdateSnowflakeDatabaseDefinitionRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "definition", u.Definition)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type UpdateSnowflakeDatabaseDefinitionRequest.
func (u *UpdateSnowflakeDatabaseDefinitionRequest) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
...
// MarshalJSON implements the json.Marshaller interface for type UpdateSnowflakeDatabaseRequest.
func (u UpdateSnowflakeDatabaseRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type UpdateSnowflakeDatabaseRequest.
func (u *UpdateSnowflakeDatabaseRequest) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", u, err)
	}
