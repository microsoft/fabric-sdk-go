...
// CreateOrgAppRequest - Create OrgApp request payload.
type CreateOrgAppRequest struct {
	// REQUIRED; The OrgApp display name. The display name must follow naming rules according to item type.
	DisplayName *string

	// The OrgApp public definition.
	Definition *PublicDefinition

	// The OrgApp description. Maximum length is 256 characters.
	Description *string

	// The folder ID. If not specified or null, the OrgApp is created with the workspace as its folder.
	FolderID *string

	// The sensitivity label settings for the OrgApp.
	SensitivityLabelSettings *SensitivityLabelSettings
}

// DefinitionResponse - OrgApp public definition response.
type DefinitionResponse struct {
	// READ-ONLY; OrgApp public definition object. Refer to this article [/rest/api/fabric/articles/item-management/definitions/orgapp-definition]
	// for more details on the structure of the OrgApp definition.
	Definition *PublicDefinition
}
...
// OrgApps - A list of OrgApps.
type OrgApps struct {
	// REQUIRED; The list of OrgApps.
	Value []OrgApp
...
// Properties - The OrgApp properties.
type Properties struct {
	// REQUIRED; OneLake path to the OrgApp root directory.
	OneLakeRootPath *string
}

// PublicDefinition - OrgApp public definition object. Refer to this article [/rest/api/fabric/articles/item-management/definitions/orgapp-definition]
// for more details on the structure of the OrgApp definition.
type PublicDefinition struct {
	// REQUIRED; A list of definition parts.
	Parts []PublicDefinitionPart

	// The format of the OrgApp definition.
	Format *string
}

// PublicDefinitionPart - OrgApp definition part object.
type PublicDefinitionPart struct {
	// The OrgApp public definition part path.
	Path *string

	// The OrgApp public definition part payload.
	Payload *string
...
// UpdateOrgAppDefinitionRequest - Update OrgApp public definition request payload.
type UpdateOrgAppDefinitionRequest struct {
	// REQUIRED; OrgApp public definition object. Refer to this article [/rest/api/fabric/articles/item-management/definitions/orgapp-definition]
	// for more details on the structure of the OrgApp definition.
	Definition *PublicDefinition
}

// UpdateOrgAppRequest - Update OrgApp request.
type UpdateOrgAppRequest struct {
	// The OrgApp description. Maximum length is 256 characters.
	Description *string

	// The OrgApp display name. The display name must follow naming rules according to item type.
	DisplayName *string
}
