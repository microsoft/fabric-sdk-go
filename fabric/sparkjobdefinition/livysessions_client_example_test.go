...
func ExampleLivySessionsClient_NewListLivySessionsPager() {
	...
	pager := clientFactory.NewLivySessionsClient().NewListLivySessionsPager("f8113ba8-dd81-443e-811a-b385340f3f05", "8cee7699-2e81-4121-9a53-cc9025046193", &sparkjobdefinition.LivySessionsClientListLivySessionsOptions{ContinuationToken: nil})
	for pager.More() {
		...
		// page.LivySessions = sparkjobdefinition.LivySessions{
...
func ExampleLivySessionsClient_NewListLivySessionsPreviewPager() {
	...
	pager := clientFactory.NewLivySessionsClient().NewListLivySessionsPreviewPager("f8113ba8-dd81-443e-811a-b385340f3f05", "8cee7699-2e81-4121-9a53-cc9025046193", true, &sparkjobdefinition.LivySessionsClientListLivySessionsPreviewOptions{SubmittedDateTime: nil,
		EndDateTime:       nil,
...
func ExampleLivySessionsClient_GetLivySession() {
	...
	// res.LivySession = sparkjobdefinition.LivySession{
	// 	AttemptNumber: to.Ptr[int32](1),
	// 	CancellationReason: to.Ptr("User cancelled the Spark batch"),
	// 	CapacityID: to.Ptr("3c0cd366-dc28-4b6d-a525-4d415a8666e7"),
	// 	CreatorItem: &sparkjobdefinition.ItemReferenceByID{
