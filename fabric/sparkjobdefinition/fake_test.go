...
func (testsuite *FakeTestSuite) SetupSuite() {
	...
	testsuite.clientFactory, err = sparkjobdefinition.NewClientFactory(testsuite.cred, nil, &fabric.ClientOptions{
...
func (testsuite *FakeTestSuite) TestLivySessions_ListLivySessions() {
	...
	pager := client.NewListLivySessionsPager(exampleWorkspaceID, exampleSparkJobDefinitionID, &sparkjobdefinition.LivySessionsClientListLivySessionsOptions{ContinuationToken: nil})
	for pager.More() {
		nextResult, err := pager.NextPage(ctx)
		testsuite.Require().NoError(err, "Failed to advance page for example ")
