...
func (testsuite *FakeTestSuite) SetupSuite() {
	...
	testsuite.clientFactory, err = semanticmodel.NewClientFactory(testsuite.cred, nil, &fabric.ClientOptions{
...
func (testsuite *FakeTestSuite) TestItems_ListSemanticModels() {
	...
	pager := client.NewListSemanticModelsPager(exampleWorkspaceID, &semanticmodel.ItemsClientListSemanticModelsOptions{Recursive: nil,
		RootFolderID:      nil,
