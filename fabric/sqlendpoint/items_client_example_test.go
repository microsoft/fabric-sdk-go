...
func ExampleItemsClient_NewListSQLEndpointsPager() {
	...
	pager := clientFactory.NewItemsClient().NewListSQLEndpointsPager("cfafbeb1-8037-4d0c-896e-a46fb27ff229", &sqlendpoint.ItemsClientListSQLEndpointsOptions{Recursive: nil,
		RootFolderID:      nil,
