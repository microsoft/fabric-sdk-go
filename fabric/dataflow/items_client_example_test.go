...
func ExampleItemsClient_BeginGetDataflowDefinition() {
	...
	poller, err := clientFactory.NewItemsClient().BeginGetDataflowDefinition(ctx, "6e335e92-a2a2-4b5a-970a-bd6a89fbb765", "cfafbeb1-8037-4d0c-896e-a46fb27ff229", &dataflow.ItemsClientBeginGetDataflowDefinitionOptions{Format: nil})
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
