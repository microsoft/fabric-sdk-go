...
// CreateOrgAppAudienceRequest - Create OrgAppAudience request payload.
type CreateOrgAppAudienceRequest struct {
	// REQUIRED; The OrgAppAudience display name. The display name must follow naming rules according to item type.
	DisplayName *string

	// The OrgAppAudience public definition.
	Definition *PublicDefinition

	// The OrgAppAudience description. Maximum length is 256 characters.
	Description *string

	// The folder ID. If not specified or null, the OrgAppAudience is created with the workspace as its folder.
	FolderID *string

	// The sensitivity label settings for the OrgAppAudience.
	SensitivityLabelSettings *SensitivityLabelSettings
}

// DefinitionResponse - OrgAppAudience public definition response.
type DefinitionResponse struct {
	// READ-ONLY; OrgAppAudience public definition object. Refer to this article [/rest/api/fabric/articles/item-management/definitions/orgappaudience-definition]
	// for more details on the structure of the OrgAppAudience
	// definition.
	Definition *PublicDefinition
}
...
// OrgAppAudience - An OrgAppAudience object.
type OrgAppAudience struct {
...
// OrgAppAudiences - A list of OrgAppAudiences.
type OrgAppAudiences struct {
	// REQUIRED; The list of OrgAppAudiences.
	Value []OrgAppAudience
...
// Properties - The OrgAppAudience properties.
type Properties struct {
	// REQUIRED; OneLake path to the OrgAppAudience root directory.
	OneLakeRootPath *string
}

// PublicDefinition - OrgAppAudience public definition object. Refer to this article [/rest/api/fabric/articles/item-management/definitions/orgappaudience-definition]
// for more details on the structure of the OrgAppAudience
// definition.
type PublicDefinition struct {
	...
	// The format of the OrgAppAudience definition.
	Format *string
}

// PublicDefinitionPart - OrgAppAudience definition part object.
type PublicDefinitionPart struct {
	// The OrgAppAudience public definition part path.
	Path *string

	// The OrgAppAudience public definition part payload.
	Payload *string
...
// UpdateOrgAppAudienceDefinitionRequest - Update OrgAppAudience public definition request payload.
type UpdateOrgAppAudienceDefinitionRequest struct {
	// REQUIRED; OrgAppAudience public definition object. Refer to this article [/rest/api/fabric/articles/item-management/definitions/orgappaudience-definition]
	// for more details on the structure of the OrgAppAudience
	// definition.
	Definition *PublicDefinition
}

// UpdateOrgAppAudienceRequest - Update OrgAppAudience request.
type UpdateOrgAppAudienceRequest struct {
	// The OrgAppAudience description. Maximum length is 256 characters.
	Description *string

	// The OrgAppAudience display name. The display name must follow naming rules according to item type.
	DisplayName *string
}
