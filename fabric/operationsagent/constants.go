...
// AgentState - The current state of the OperationsAgent. Additional AgentState values may be added over time.
type AgentState string

const (
	// AgentStateActive - The OperationsAgent is active and running.
	AgentStateActive AgentState = "Active"
	// AgentStateInactive - The OperationsAgent is inactive and not running.
	AgentStateInactive AgentState = "Inactive"
)

// PossibleAgentStateValues returns the possible values for the AgentState const type.
...
const (
	// DefinitionFormatOperationsAgentV1 - Custom format for the OperationsAgent public definition, specifically designed to support
	// CI/CD scenarios in Fabric. see [OperationsAgent - OperationsAgentV1 specification](/rest/api/fabric/articles/item-management/definitions/operations-agent/operationsagentv1)
	// for more details.
	DefinitionFormatOperationsAgentV1 DefinitionFormat = "OperationsAgentV1"
)

// PossibleOperationsAgentDefinitionFormatValues returns the possible values for the DefinitionFormat const type.
func PossibleOperationsAgentDefinitionFormatValues() []DefinitionFormat {
	return []DefinitionFormat{
		DefinitionFormatOperationsAgentV1,
	}
}
