...
// Generated from example definition
func ExampleStagingClient_GetSparkCompute() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	res, err := clientFactory.NewStagingClient().GetSparkCompute(ctx, "f089354e-8366-4e18-aea3-4cb4a3a50b48", "707cfd07-cbf1-41da-aad7-dd157ddb8c11", false, nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
...
// Generated from example definition
func ExampleStagingClient_UpdateSparkCompute_updateEnvironmentStagingSparkComputeExample() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	res, err := clientFactory.NewStagingClient().UpdateSparkCompute(ctx, "f089354e-8366-4e18-aea3-4cb4a3a50b48", "707cfd07-cbf1-41da-aad7-dd157ddb8c11", false, environment.UpdateEnvironmentSparkComputeRequest{
		DriverCores:  to.Ptr[int32](4),
		DriverMemory: to.Ptr(environment.CustomPoolMemoryFiftySixG),
		DynamicExecutorAllocation: &environment.DynamicExecutorAllocationProperties{
			Enabled:      to.Ptr(false),
...
// Generated from example definition
func ExampleStagingClient_UpdateSparkCompute_updateEnvironmentStagingSparkComputeInstancePoolUsingPoolIdExample() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
...
// Generated from example definition
func ExampleStagingClient_NewListLibrariesPager() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	pager := clientFactory.NewStagingClient().NewListLibrariesPager("f089354e-8366-4e18-aea3-4cb4a3a50b48", "41ce06d1-d81b-4ea0-bc6d-2ce3dd2f8e87", false, &environment.StagingClientListLibrariesOptions{ContinuationToken: nil})
	for pager.More() {
...
// Generated from example definition
func ExampleStagingClient_UploadCustomLibrary() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	_, err = clientFactory.NewStagingClient().UploadCustomLibrary(ctx, "f089354e-8366-4e18-aea3-4cb4a3a50b48", "41ce06d1-d81b-4ea0-bc6d-2ce3dd2f8e87", "samplelibrary.jar", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
}
...
// Generated from example definition
func ExampleStagingClient_DeleteCustomLibrary() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	_, err = clientFactory.NewStagingClient().DeleteCustomLibrary(ctx, "f089354e-8366-4e18-aea3-4cb4a3a50b48", "41ce06d1-d81b-4ea0-bc6d-2ce3dd2f8e87", "samplelibrary.jar", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
}
...
// Generated from example definition
func ExampleStagingClient_RemoveExternalLibrary() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	_, err = clientFactory.NewStagingClient().RemoveExternalLibrary(ctx, "f089354e-8366-4e18-aea3-4cb4a3a50b48", "41ce06d1-d81b-4ea0-bc6d-2ce3dd2f8e87", environment.RemoveExternalLibrariesRequest{
		Name:    to.Ptr("fuzzywuzzy"),
		Version: to.Ptr("0.0.1"),
	}, nil)
	if err != nil {
...
// Generated from example definition
func ExampleStagingClient_ImportExternalLibraries() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	_, err = clientFactory.NewStagingClient().ImportExternalLibraries(ctx, "f089354e-8366-4e18-aea3-4cb4a3a50b48", "41ce06d1-d81b-4ea0-bc6d-2ce3dd2f8e87", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
}
...
// Generated from example definition
func ExampleStagingClient_ExportExternalLibraries() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	_, err = clientFactory.NewStagingClient().ExportExternalLibraries(ctx, "f089354e-8366-4e18-aea3-4cb4a3a50b48", "41ce06d1-d81b-4ea0-bc6d-2ce3dd2f8e87", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
}
