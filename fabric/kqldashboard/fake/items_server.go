...
func (i *ItemsServerTransport) dispatchDeleteKQLDashboard(req *http.Request) (*http.Response, error) {
	...
	var options *kqldashboard.ItemsClientDeleteKQLDashboardOptions
	if hardDeleteParam != nil {
		options = &kqldashboard.ItemsClientDeleteKQLDashboardOptions{
			HardDelete: hardDeleteParam,
		}
	}
	respr, errRespr := i.srv.DeleteKQLDashboard(req.Context(), workspaceIDParam, kqlDashboardIDParam, options)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
