...
// ServerFactoryTransport connects instances of kqldashboard.ClientFactory to instances of ServerFactory.
...
// The returned ServerFactoryTransport instance is connected to an instance of kqldashboard.ClientFactory via the
