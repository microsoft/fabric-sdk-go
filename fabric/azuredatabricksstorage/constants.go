...
type AzureDatabricksStorageDefinitionFormat string

const (
	// AzureDatabricksStorageDefinitionFormatAzureDatabricksStorageV1 - AzureDatabricksStorage version 1 definition format.
	AzureDatabricksStorageDefinitionFormatAzureDatabricksStorageV1 AzureDatabricksStorageDefinitionFormat = "AzureDatabricksStorageV1"
)

// PossibleAzureDatabricksStorageDefinitionFormatValues returns the possible values for the AzureDatabricksStorageDefinitionFormat const type.
func PossibleAzureDatabricksStorageDefinitionFormatValues() []AzureDatabricksStorageDefinitionFormat {
	return []AzureDatabricksStorageDefinitionFormat{
		AzureDatabricksStorageDefinitionFormatAzureDatabricksStorageV1,
	}
}
