...
func (testsuite *FakeTestSuite) SetupSuite() {
	...
	testsuite.clientFactory, err = mounteddatafactory.NewClientFactory(testsuite.cred, nil, &fabric.ClientOptions{
...
func (testsuite *FakeTestSuite) TestItems_ListMountedDataFactories() {
	...
	pager := client.NewListMountedDataFactoriesPager(exampleWorkspaceID, &mounteddatafactory.ItemsClientListMountedDataFactoriesOptions{Recursive: nil,
		RootFolderID:      nil,
