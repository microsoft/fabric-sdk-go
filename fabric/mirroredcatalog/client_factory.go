...
// NewDiscoveryClient creates a new instance of DiscoveryClient.
func (c *ClientFactory) NewDiscoveryClient() *DiscoveryClient {
	return &DiscoveryClient{
		internal: c.internal.WithClientName("mirroredcatalog.DiscoveryClient"),
		endpoint: c.endpoint,
	}
}
...
func (c *ClientFactory) NewItemsClient() *ItemsClient {
	return &ItemsClient{
		internal: c.internal.WithClientName("mirroredcatalog.ItemsClient"),
		endpoint: c.endpoint,
	}
}

// NewMonitoringClient creates a new instance of MonitoringClient.
func (c *ClientFactory) NewMonitoringClient() *MonitoringClient {
	return &MonitoringClient{
		internal: c.internal.WithClientName("mirroredcatalog.MonitoringClient"),
		endpoint: c.endpoint,
	}
}

// NewRefreshClient creates a new instance of RefreshClient.
func (c *ClientFactory) NewRefreshClient() *RefreshClient {
	return &RefreshClient{
		internal: c.internal.WithClientName("mirroredcatalog.RefreshClient"),
		endpoint: c.endpoint,
	}
}
