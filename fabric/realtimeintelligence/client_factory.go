...
// NewCopilotClient creates a new instance of CopilotClient.
func (c *ClientFactory) NewCopilotClient() *CopilotClient {
	return &CopilotClient{
		internal: c.internal.WithClientName("realtimeintelligence.CopilotClient"),
		endpoint: c.endpoint,
	}
}
