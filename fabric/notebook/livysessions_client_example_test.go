...
func ExampleLivySessionsClient_NewListLivySessionsPager() {
	...
	pager := clientFactory.NewLivySessionsClient().NewListLivySessionsPager("f8113ba8-dd81-443e-811a-b385340f3f05", "8cee7699-2e81-4121-9a53-cc9025046193", &notebook.LivySessionsClientListLivySessionsOptions{ContinuationToken: nil})
	for pager.More() {
...
func ExampleLivySessionsClient_NewListLivySessionsPreviewPager() {
	...
	pager := clientFactory.NewLivySessionsClient().NewListLivySessionsPreviewPager("f8113ba8-dd81-443e-811a-b385340f3f05", "8cee7699-2e81-4121-9a53-cc9025046193", true, &notebook.LivySessionsClientListLivySessionsPreviewOptions{SubmittedDateTime: nil,
		EndDateTime:       nil,
		SubmitterID:       nil,
		State:             nil,
