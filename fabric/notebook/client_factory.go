...
func (c *ClientFactory) NewBackgroundJobsClient() *BackgroundJobsClient {
	return &BackgroundJobsClient{
		internal: c.internal.WithClientName("notebook.BackgroundJobsClient"),
		endpoint: c.endpoint,
	}
}
...
func (c *ClientFactory) NewItemsClient() *ItemsClient {
	return &ItemsClient{
		internal: c.internal.WithClientName("notebook.ItemsClient"),
		endpoint: c.endpoint,
	}
}
...
func (c *ClientFactory) NewLivySessionsClient() *LivySessionsClient {
	return &LivySessionsClient{
		internal: c.internal.WithClientName("notebook.LivySessionsClient"),
		endpoint: c.endpoint,
	}
}
