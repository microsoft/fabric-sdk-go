...
type LivySessionsServer struct {
	...
	// HTTP status codes to indicate success: http.StatusOK
	NewListLivySessionsPreviewPager func(workspaceID string, notebookID string, preview bool, options *notebook.LivySessionsClientListLivySessionsPreviewOptions) (resp azfake.PagerResponder[notebook.LivySessionsClientListLivySessionsPreviewResponse])
}
...
func NewLivySessionsServerTransport(srv *LivySessionsServer) *LivySessionsServerTransport {
	return &LivySessionsServerTransport{
		...
		newListLivySessionsPreviewPager: newTracker[azfake.PagerResponder[notebook.LivySessionsClientListLivySessionsPreviewResponse]](),
	}
}
...
type LivySessionsServerTransport struct {
	...
	newListLivySessionsPreviewPager *tracker[azfake.PagerResponder[notebook.LivySessionsClientListLivySessionsPreviewResponse]]
}
...
func (l *LivySessionsServerTransport) dispatchNewListLivySessionsPreviewPager(req *http.Request) (*http.Response, error) {
	...
	if newListLivySessionsPreviewPager == nil {
		...
		continuationTokenParam := getOptional(continuationTokenUnescaped)
		var options *notebook.LivySessionsClientListLivySessionsPreviewOptions
		if submittedDateTimeParam != nil || endDateTimeParam != nil || submitterIDParam != nil || stateParam != nil || continuationTokenParam != nil {
			options = &notebook.LivySessionsClientListLivySessionsPreviewOptions{
		...
		resp := l.srv.NewListLivySessionsPreviewPager(workspaceIDParam, notebookIDParam, previewParam, options)
		newListLivySessionsPreviewPager = &resp
		l.newListLivySessionsPreviewPager.add(req, newListLivySessionsPreviewPager)
		server.PagerResponderInjectNextLinks(newListLivySessionsPreviewPager, req, func(page *notebook.LivySessionsClientListLivySessionsPreviewResponse, createLink func() string) {
			page.ContinuationURI = to.Ptr(createLink())
		})
	}
