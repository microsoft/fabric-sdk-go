...
type LivySessionsServer struct {
	...
	// HTTP status codes to indicate success: http.StatusOK
	NewListLivySessionsBetaPager func(workspaceID string, notebookID string, beta bool, options *notebook.LivySessionsClientListLivySessionsBetaOptions) (resp azfake.PagerResponder[notebook.LivySessionsClientListLivySessionsBetaResponse])
}
...
func NewLivySessionsServerTransport(srv *LivySessionsServer) *LivySessionsServerTransport {
	return &LivySessionsServerTransport{
		...
		newListLivySessionsBetaPager: newTracker[azfake.PagerResponder[notebook.LivySessionsClientListLivySessionsBetaResponse]](),
	}
}
...
type LivySessionsServerTransport struct {
	...
	newListLivySessionsBetaPager *tracker[azfake.PagerResponder[notebook.LivySessionsClientListLivySessionsBetaResponse]]
}
...
func (l *LivySessionsServerTransport) dispatchNewListLivySessionsBetaPager(req *http.Request) (*http.Response, error) {
	...
	if newListLivySessionsBetaPager == nil {
		...
		continuationTokenParam := getOptional(continuationTokenUnescaped)
		var options *notebook.LivySessionsClientListLivySessionsBetaOptions
		if submittedDateTimeParam != nil || endDateTimeParam != nil || submitterIDParam != nil || stateParam != nil || continuationTokenParam != nil {
			options = &notebook.LivySessionsClientListLivySessionsBetaOptions{
		...
		resp := l.srv.NewListLivySessionsBetaPager(workspaceIDParam, notebookIDParam, betaParam, options)
		newListLivySessionsBetaPager = &resp
		l.newListLivySessionsBetaPager.add(req, newListLivySessionsBetaPager)
		server.PagerResponderInjectNextLinks(newListLivySessionsBetaPager, req, func(page *notebook.LivySessionsClientListLivySessionsBetaResponse, createLink func() string) {
			page.ContinuationURI = to.Ptr(createLink())
		})
	}
