...
func (l *LongRunningOperationsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if longRunningOperationsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = longRunningOperationsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to LongRunningOperationsServerTransport
var longRunningOperationsServerTransportInterceptor interface {
