...
// MarshalJSON implements the json.Marshaller interface for type AcceptExternalDataShareInvitationRequest.
func (a AcceptExternalDataShareInvitationRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "itemId", a.ItemID)
	populate(objectMap, "payload", a.Payload)
	populate(objectMap, "providerTenantId", a.ProviderTenantID)
	populate(objectMap, "workspaceId", a.WorkspaceID)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type AcceptExternalDataShareInvitationRequest.
func (a *AcceptExternalDataShareInvitationRequest) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "itemId":
			...
			delete(rawMsg, key)
		case "payload":
			a.Payload, err = unmarshalExternalDataShareAcceptRequestPayloadClassification(val)
			delete(rawMsg, key)
		case "providerTenantId":
			err = unpopulate(val, "ProviderTenantID", &a.ProviderTenantID)
			delete(rawMsg, key)
		case "workspaceId":
...
// MarshalJSON implements the json.Marshaller interface for type AcceptExternalDataShareInvitationResponse.
func (a AcceptExternalDataShareInvitationResponse) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "value", a.Value)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type AcceptExternalDataShareInvitationResponse.
func (a *AcceptExternalDataShareInvitationResponse) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", a, err)
	}
...
func (a *AddConnectionRoleAssignmentRequest) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "principal":
			a.Principal, err = unmarshalPrincipalClassification(val)
			delete(rawMsg, key)
		case "role":
...
// MarshalJSON implements the json.Marshaller interface for type ApplyTagsRequest.
func (a ApplyTagsRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "tags", a.Tags)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ApplyTagsRequest.
func (a *ApplyTagsRequest) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", a, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type ApplyWorkspaceTagsRequest.
func (a ApplyWorkspaceTagsRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "tags", a.Tags)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ApplyWorkspaceTagsRequest.
func (a *ApplyWorkspaceTagsRequest) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", a, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type AssignWorkspaceEncryptionRequest.
func (a AssignWorkspaceEncryptionRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "keyIdentifier", a.KeyIdentifier)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type AssignWorkspaceEncryptionRequest.
func (a *AssignWorkspaceEncryptionRequest) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", a, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type AssignWorkspaceToDomainRequest.
func (a AssignWorkspaceToDomainRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "domainId", a.DomainID)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type AssignWorkspaceToDomainRequest.
func (a *AssignWorkspaceToDomainRequest) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", a, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "domainId":
			err = unpopulate(val, "DomainID", &a.DomainID)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", a, err)
...
// MarshalJSON implements the json.Marshaller interface for type BulkCreateShortcutResponse.
func (b BulkCreateShortcutResponse) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "value", b.Value)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type BulkCreateShortcutResponse.
func (b *BulkCreateShortcutResponse) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", b, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type BulkCreateShortcutsRequest.
func (b BulkCreateShortcutsRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "createShortcutRequests", b.CreateShortcutRequests)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type BulkCreateShortcutsRequest.
func (b *BulkCreateShortcutsRequest) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", b, err)
	}
	for key, val := range rawMsg {
		var err error
		switch key {
		case "createShortcutRequests":
			err = unpopulate(val, "CreateShortcutRequests", &b.CreateShortcutRequests)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", b, err)
...
// MarshalJSON implements the json.Marshaller interface for type BulkExportItemDefinitionsRequest.
func (b BulkExportItemDefinitionsRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type BulkExportItemDefinitionsRequest.
func (b *BulkExportItemDefinitionsRequest) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", b, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type BulkExportItemDefinitionsResponse.
func (b BulkExportItemDefinitionsResponse) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "definitionParts", b.DefinitionParts)
	populate(objectMap, "itemDefinitionsIndex", b.ItemDefinitionsIndex)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type BulkExportItemDefinitionsResponse.
func (b *BulkExportItemDefinitionsResponse) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", b, err)
	}
	for key, val := range rawMsg {
		var err error
		switch key {
		case "definitionParts":
			err = unpopulate(val, "DefinitionParts", &b.DefinitionParts)
			delete(rawMsg, key)
		case "itemDefinitionsIndex":
			err = unpopulate(val, "ItemDefinitionsIndex", &b.ItemDefinitionsIndex)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", b, err)
...
// MarshalJSON implements the json.Marshaller interface for type BulkImportItemDefinitionsRequest.
func (b BulkImportItemDefinitionsRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "definitionParts", b.DefinitionParts)
	populate(objectMap, "options", b.Options)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type BulkImportItemDefinitionsRequest.
func (b *BulkImportItemDefinitionsRequest) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", b, err)
	}
	for key, val := range rawMsg {
		...
		case "definitionParts":
			...
			delete(rawMsg, key)
		case "options":
			err = unpopulate(val, "Options", &b.Options)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", b, err)
...
// MarshalJSON implements the json.Marshaller interface for type BulkImportItemDefinitionsRequestOptions.
func (b BulkImportItemDefinitionsRequestOptions) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "allowPairingByName", b.AllowPairingByName)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type BulkImportItemDefinitionsRequestOptions.
func (b *BulkImportItemDefinitionsRequestOptions) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", b, err)
	}
	for key, val := range rawMsg {
		var err error
		switch key {
		case "allowPairingByName":
			err = unpopulate(val, "AllowPairingByName", &b.AllowPairingByName)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", b, err)
...
// MarshalJSON implements the json.Marshaller interface for type BulkImportItemDefinitionsResponse.
func (b BulkImportItemDefinitionsResponse) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "importItemDefinitionsDetails", b.ImportItemDefinitionsDetails)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type BulkImportItemDefinitionsResponse.
func (b *BulkImportItemDefinitionsResponse) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", b, err)
	}
	for key, val := range rawMsg {
		var err error
		switch key {
		case "importItemDefinitionsDetails":
			err = unpopulate(val, "ImportItemDefinitionsDetails", &b.ImportItemDefinitionsDetails)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", b, err)
...
// MarshalJSON implements the json.Marshaller interface for type BulkMoveItemsRequest.
func (b BulkMoveItemsRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "items", b.Items)
	populate(objectMap, "targetFolderId", b.TargetFolderID)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type BulkMoveItemsRequest.
func (b *BulkMoveItemsRequest) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", b, err)
	}
	for key, val := range rawMsg {
		...
		case "items":
			...
			delete(rawMsg, key)
		case "targetFolderId":
			err = unpopulate(val, "TargetFolderID", &b.TargetFolderID)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", b, err)
...
// MarshalJSON implements the json.Marshaller interface for type CSVToDeltaTransform.
func (c CSVToDeltaTransform) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "includeSubfolders", c.IncludeSubfolders)
	populate(objectMap, "properties", c.Properties)
	objectMap["type"] = TransformTypeCSVToDelta
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type CSVToDeltaTransform.
func (c *CSVToDeltaTransform) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
	...
	for key, val := range rawMsg {
		...
		case "includeSubfolders":
			err = unpopulate(val, "IncludeSubfolders", &c.IncludeSubfolders)
			delete(rawMsg, key)
		case "properties":
...
// MarshalJSON implements the json.Marshaller interface for type CSVToDeltaTransformProperties.
func (c CSVToDeltaTransformProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "delimiter", c.Delimiter)
	populate(objectMap, "skipFilesWithErrors", c.SkipFilesWithErrors)
	populate(objectMap, "useFirstRowAsHeader", c.UseFirstRowAsHeader)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type CSVToDeltaTransformProperties.
func (c *CSVToDeltaTransformProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
	for key, val := range rawMsg {
		...
		case "delimiter":
			...
			delete(rawMsg, key)
		case "skipFilesWithErrors":
			err = unpopulate(val, "SkipFilesWithErrors", &c.SkipFilesWithErrors)
			delete(rawMsg, key)
		case "useFirstRowAsHeader":
			err = unpopulate(val, "UseFirstRowAsHeader", &c.UseFirstRowAsHeader)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", c, err)
...
// MarshalJSON implements the json.Marshaller interface for type CatalogEntry.
func (c CatalogEntry) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	objectMap["catalogEntryType"] = c.CatalogEntryType
...
// UnmarshalJSON implements the json.Unmarshaller interface for type CatalogEntry.
func (c *CatalogEntry) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
	for key, val := range rawMsg {
		var err error
		switch key {
		case "catalogEntryType":
			err = unpopulate(val, "CatalogEntryType", &c.CatalogEntryType)
			delete(rawMsg, key)
		case "description":
...
// MarshalJSON implements the json.Marshaller interface for type CatalogQueryRequest.
func (c CatalogQueryRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "continuationToken", c.ContinuationToken)
	populate(objectMap, "filter", c.Filter)
	populate(objectMap, "pageSize", c.PageSize)
	populate(objectMap, "search", c.Search)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type CatalogQueryRequest.
func (c *CatalogQueryRequest) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
	for key, val := range rawMsg {
		...
		case "pageSize":
			...
			delete(rawMsg, key)
		case "search":
			err = unpopulate(val, "Search", &c.Search)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", c, err)
...
// MarshalJSON implements the json.Marshaller interface for type CatalogQueryResponse.
func (c CatalogQueryResponse) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "continuationToken", c.ContinuationToken)
	populate(objectMap, "value", c.Value)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type CatalogQueryResponse.
func (c *CatalogQueryResponse) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
	for key, val := range rawMsg {
		...
		case "continuationToken":
			...
			delete(rawMsg, key)
		case "value":
			c.Value, err = unmarshalCatalogEntryClassificationArray(val)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", c, err)
...
// MarshalJSON implements the json.Marshaller interface for type CatalogWorkspace.
func (c CatalogWorkspace) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "displayName", c.DisplayName)
	populate(objectMap, "id", c.ID)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type CatalogWorkspace.
func (c *CatalogWorkspace) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type ColumnConstraint.
func (c ColumnConstraint) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "columnAction", c.ColumnAction)
	populate(objectMap, "columnEffect", c.ColumnEffect)
	populate(objectMap, "columnNames", c.ColumnNames)
	populate(objectMap, "tablePath", c.TablePath)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ColumnConstraint.
func (c *ColumnConstraint) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "columnAction":
			err = unpopulate(val, "ColumnAction", &c.ColumnAction)
			delete(rawMsg, key)
		case "columnEffect":
			err = unpopulate(val, "ColumnEffect", &c.ColumnEffect)
			delete(rawMsg, key)
		case "columnNames":
			err = unpopulate(val, "ColumnNames", &c.ColumnNames)
			delete(rawMsg, key)
		case "tablePath":
			err = unpopulate(val, "TablePath", &c.TablePath)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", c, err)
...
func (c Connection) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "connectionRecency", c.ConnectionRecency)
...
func (c *Connection) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "connectionDetails":
			...
			delete(rawMsg, key)
		case "connectionRecency":
			err = unpopulate(val, "ConnectionRecency", &c.ConnectionRecency)
			delete(rawMsg, key)
...
func (c ConnectionCreationMetadata) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "supportedCredentialTypesForUsageInUserControlledCode", c.SupportedCredentialTypesForUsageInUserControlledCode)
...
func (c *ConnectionCreationMetadata) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "supportedCredentialTypes":
			...
			delete(rawMsg, key)
		case "supportedCredentialTypesForUsageInUserControlledCode":
			err = unpopulate(val, "SupportedCredentialTypesForUsageInUserControlledCode", &c.SupportedCredentialTypesForUsageInUserControlledCode)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type ConnectionRecency.
func (c ConnectionRecency) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateDateTimeRFC3339(objectMap, "createdDateTime", c.CreatedDateTime)
	populateDateTimeRFC3339(objectMap, "lastBoundDateTime", c.LastBoundDateTime)
	populateDateTimeRFC3339(objectMap, "lastCredentialUsedDateTime", c.LastCredentialUsedDateTime)
	populateDateTimeRFC3339(objectMap, "myLastBoundDateTime", c.MyLastBoundDateTime)
	populateDateTimeRFC3339(objectMap, "myLastCredentialUsedDateTime", c.MyLastCredentialUsedDateTime)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ConnectionRecency.
func (c *ConnectionRecency) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
	for key, val := range rawMsg {
		...
		case "createdDateTime":
			...
			delete(rawMsg, key)
		case "lastBoundDateTime":
			err = unpopulateDateTimeRFC3339(val, "LastBoundDateTime", &c.LastBoundDateTime)
			delete(rawMsg, key)
		case "lastCredentialUsedDateTime":
			err = unpopulateDateTimeRFC3339(val, "LastCredentialUsedDateTime", &c.LastCredentialUsedDateTime)
			delete(rawMsg, key)
		case "myLastBoundDateTime":
			err = unpopulateDateTimeRFC3339(val, "MyLastBoundDateTime", &c.MyLastBoundDateTime)
			delete(rawMsg, key)
		case "myLastCredentialUsedDateTime":
			err = unpopulateDateTimeRFC3339(val, "MyLastCredentialUsedDateTime", &c.MyLastCredentialUsedDateTime)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", c, err)
...
func (c *ConnectionRoleAssignment) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "id":
			...
			delete(rawMsg, key)
		case "principal":
			c.Principal, err = unmarshalPrincipalClassification(val)
			delete(rawMsg, key)
		case "role":
...
// MarshalJSON implements the json.Marshaller interface for type ConnectionRuleEndpointMetadata.
func (c ConnectionRuleEndpointMetadata) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "hostnamePattern", c.HostnamePattern)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ConnectionRuleEndpointMetadata.
func (c *ConnectionRuleEndpointMetadata) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
	for key, val := range rawMsg {
		...
		case "hostnamePattern":
			err = unpopulate(val, "HostnamePattern", &c.HostnamePattern)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", c, err)
...
// MarshalJSON implements the json.Marshaller interface for type ConnectionRuleWorkspaceMetadata.
func (c ConnectionRuleWorkspaceMetadata) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "workspaceId", c.WorkspaceID)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ConnectionRuleWorkspaceMetadata.
func (c *ConnectionRuleWorkspaceMetadata) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type ConnectionStatusError.
func (c ConnectionStatusError) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ConnectionStatusError.
func (c *ConnectionStatusError) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type ConnectionStatusResponse.
func (c ConnectionStatusResponse) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ConnectionStatusResponse.
func (c *ConnectionStatusResponse) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
...
func (c CreateCloudConnectionRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "allowConnectionUsageInGateway", c.AllowConnectionUsageInGateway)
	populate(objectMap, "allowUsageInUserControlledCode", c.AllowUsageInUserControlledCode)
	populate(objectMap, "connectionDetails", c.ConnectionDetails)
...
func (c *CreateCloudConnectionRequest) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		var err error
		switch key {
		case "allowConnectionUsageInGateway":
			err = unpopulate(val, "AllowConnectionUsageInGateway", &c.AllowConnectionUsageInGateway)
			delete(rawMsg, key)
		case "allowUsageInUserControlledCode":
			err = unpopulate(val, "AllowUsageInUserControlledCode", &c.AllowUsageInUserControlledCode)
			delete(rawMsg, key)
		case "connectionDetails":
			err = unpopulate(val, "ConnectionDetails", &c.ConnectionDetails)
			delete(rawMsg, key)
...
func (c *CreateExternalDataShareRequest) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "paths":
			...
			delete(rawMsg, key)
		case "recipient":
			c.Recipient, err = unmarshalBaseExternalDataShareRecipientClassification(val)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", c, err)
...
// MarshalJSON implements the json.Marshaller interface for type CreateExternalDataShareShortcutRequest.
func (c CreateExternalDataShareShortcutRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "pathId", c.PathID)
	populate(objectMap, "shortcutName", c.ShortcutName)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type CreateExternalDataShareShortcutRequest.
func (c *CreateExternalDataShareShortcutRequest) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "pathId":
			err = unpopulate(val, "PathID", &c.PathID)
			delete(rawMsg, key)
		case "shortcutName":
			err = unpopulate(val, "ShortcutName", &c.ShortcutName)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", c, err)
...
func (c CreateManagedPrivateEndpointRequest) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "targetFQDNs", c.TargetFQDNs)
...
func (c *CreateManagedPrivateEndpointRequest) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "requestMessage":
			...
			delete(rawMsg, key)
		case "targetFQDNs":
			err = unpopulate(val, "TargetFQDNs", &c.TargetFQDNs)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type CreateShortcutResponse.
func (c CreateShortcutResponse) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type CreateShortcutResponse.
func (c *CreateShortcutResponse) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type CreateShortcutResponseRequest.
func (c CreateShortcutResponseRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "name", c.Name)
	populate(objectMap, "path", c.Path)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type CreateShortcutResponseRequest.
func (c *CreateShortcutResponseRequest) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type CreateShortcutWithTransformRequest.
func (c CreateShortcutWithTransformRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "name", c.Name)
	populate(objectMap, "path", c.Path)
	populate(objectMap, "target", c.Target)
	populate(objectMap, "transform", c.Transform)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type CreateShortcutWithTransformRequest.
func (c *CreateShortcutWithTransformRequest) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
	for key, val := range rawMsg {
		...
		case "target":
			...
			delete(rawMsg, key)
		case "transform":
			c.Transform, err = unmarshalTransformClassification(val)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", c, err)
...
// MarshalJSON implements the json.Marshaller interface for type CreateStreamingVirtualNetworkGatewayConnectionRequest.
func (c CreateStreamingVirtualNetworkGatewayConnectionRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "connectionDetails", c.ConnectionDetails)
	objectMap["connectivityType"] = ConnectivityTypeStreamingVirtualNetworkGateway
	populate(objectMap, "credentialDetails", c.CredentialDetails)
	populate(objectMap, "displayName", c.DisplayName)
	populate(objectMap, "gatewayId", c.GatewayID)
	populate(objectMap, "privacyLevel", c.PrivacyLevel)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type CreateStreamingVirtualNetworkGatewayConnectionRequest.
func (c *CreateStreamingVirtualNetworkGatewayConnectionRequest) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type CreateStreamingVirtualNetworkGatewayRequest.
func (c CreateStreamingVirtualNetworkGatewayRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "displayName", c.DisplayName)
	objectMap["type"] = GatewayTypeStreamingVirtualNetwork
	populate(objectMap, "virtualNetworkAzureResource", c.VirtualNetworkAzureResource)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type CreateStreamingVirtualNetworkGatewayRequest.
func (c *CreateStreamingVirtualNetworkGatewayRequest) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
...
func (c CreateVirtualNetworkGatewayRequest) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "maxMemberGatewayCount", c.MaxMemberGatewayCount)
	populate(objectMap, "minMemberGatewayCount", c.MinMemberGatewayCount)
...
func (c *CreateVirtualNetworkGatewayRequest) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "inactivityMinutesBeforeSleep":
			...
			delete(rawMsg, key)
		case "maxMemberGatewayCount":
			err = unpopulate(val, "MaxMemberGatewayCount", &c.MaxMemberGatewayCount)
			delete(rawMsg, key)
		case "minMemberGatewayCount":
			err = unpopulate(val, "MinMemberGatewayCount", &c.MinMemberGatewayCount)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type CreateWorkspaceRelationRequest.
func (c CreateWorkspaceRelationRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "relatedWorkspaceId", c.RelatedWorkspaceID)
	populate(objectMap, "relationType", c.RelationType)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type CreateWorkspaceRelationRequest.
func (c *CreateWorkspaceRelationRequest) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", c, err)
	}
	for key, val := range rawMsg {
		var err error
		switch key {
		case "relatedWorkspaceId":
			err = unpopulate(val, "RelatedWorkspaceID", &c.RelatedWorkspaceID)
			delete(rawMsg, key)
		case "relationType":
			err = unpopulate(val, "RelationType", &c.RelationType)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", c, err)
...
func (c CreateWorkspaceRequest) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "description", c.Description)
	populate(objectMap, "displayName", c.DisplayName)
	populate(objectMap, "domainId", c.DomainID)
	return json.Marshal(objectMap)
}
...
func (c *CreateWorkspaceRequest) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "displayName":
			...
			delete(rawMsg, key)
		case "domainId":
			err = unpopulate(val, "DomainID", &c.DomainID)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", c, err)
...
// MarshalJSON implements the json.Marshaller interface for type DataAccessRoleBase.
func (d DataAccessRoleBase) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "decisionRules", d.DecisionRules)
	populate(objectMap, "kind", d.Kind)
	populate(objectMap, "members", d.Members)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type DataAccessRoleBase.
func (d *DataAccessRoleBase) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type DataAccessRoleListItem.
func (d DataAccessRoleListItem) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "decisionRules", d.DecisionRules)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type DataAccessRoleListItem.
func (d *DataAccessRoleListItem) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
...
func (d DecisionRule) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "constraints", d.Constraints)
...
func (d *DecisionRule) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "constraints":
			err = unpopulate(val, "Constraints", &d.Constraints)
			delete(rawMsg, key)
		case "effect":
...
// MarshalJSON implements the json.Marshaller interface for type DecisionRuleConstraints.
func (d DecisionRuleConstraints) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type DecisionRuleConstraints.
func (d *DecisionRuleConstraints) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
...
func (d *DeploymentPipelineOperation) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "note":
			...
			delete(rawMsg, key)
		case "performedBy":
			d.PerformedBy, err = unmarshalPrincipalClassification(val)
			delete(rawMsg, key)
...
func (d *DeploymentPipelineRoleAssignment) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "id":
			...
			delete(rawMsg, key)
		case "principal":
			d.Principal, err = unmarshalPrincipalClassification(val)
			delete(rawMsg, key)
		case "role":
...
// MarshalJSON implements the json.Marshaller interface for type DomainTagScope.
func (d DomainTagScope) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "domainId", d.DomainID)
	objectMap["type"] = TagScopeTypeDomain
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type DomainTagScope.
func (d *DomainTagScope) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "domainId":
			err = unpopulate(val, "DomainID", &d.DomainID)
			delete(rawMsg, key)
		case "type":
			err = unpopulate(val, "Type", &d.Type)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type Domains.
...
// UnmarshalJSON implements the json.Unmarshaller interface for type Domains.
...
// MarshalJSON implements the json.Marshaller interface for type EncryptionDetail.
func (e EncryptionDetail) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type EncryptionDetail.
func (e *EncryptionDetail) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
...
// MarshalJSON implements the json.Marshaller interface for type ExportItemIdentifier.
func (e ExportItemIdentifier) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "id", e.ID)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ExportItemIdentifier.
func (e *ExportItemIdentifier) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", e, err)
	}
...
func (e *ExternalDataShare) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "creatorPrincipal":
			e.CreatorPrincipal, err = unmarshalPrincipalClassification(val)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type ExternalDataShareAcceptRequestPayload.
func (e ExternalDataShareAcceptRequestPayload) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	objectMap["payloadType"] = e.PayloadType
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ExternalDataShareAcceptRequestPayload.
func (e *ExternalDataShareAcceptRequestPayload) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", e, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "payloadType":
			err = unpopulate(val, "PayloadType", &e.PayloadType)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", e, err)
...
// MarshalJSON implements the json.Marshaller interface for type ExternalDataShareInvitationDetails.
func (e ExternalDataShareInvitationDetails) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "pathsDetails", e.PathsDetails)
	populate(objectMap, "providerTenantDetails", e.ProviderTenantDetails)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ExternalDataShareInvitationDetails.
func (e *ExternalDataShareInvitationDetails) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", e, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "pathsDetails":
			err = unpopulate(val, "PathsDetails", &e.PathsDetails)
			delete(rawMsg, key)
		case "providerTenantDetails":
			err = unpopulate(val, "ProviderTenantDetails", &e.ProviderTenantDetails)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", e, err)
...
// MarshalJSON implements the json.Marshaller interface for type ExternalDataSharePathDetails.
func (e ExternalDataSharePathDetails) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "name", e.Name)
	populate(objectMap, "pathId", e.PathID)
	populate(objectMap, "type", e.Type)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ExternalDataSharePathDetails.
func (e *ExternalDataSharePathDetails) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", e, err)
	}
	for key, val := range rawMsg {
		...
		case "name":
			...
			delete(rawMsg, key)
		case "pathId":
			err = unpopulate(val, "PathID", &e.PathID)
			delete(rawMsg, key)
		case "type":
			err = unpopulate(val, "Type", &e.Type)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type ExternalDataShareProviderTenantDetails.
func (e ExternalDataShareProviderTenantDetails) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "displayName", e.DisplayName)
	populate(objectMap, "tenantId", e.TenantID)
	populate(objectMap, "verifiedDomainName", e.VerifiedDomainName)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ExternalDataShareProviderTenantDetails.
func (e *ExternalDataShareProviderTenantDetails) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", e, err)
	}
	for key, val := range rawMsg {
		...
		case "tenantId":
			...
			delete(rawMsg, key)
		case "verifiedDomainName":
			err = unpopulate(val, "VerifiedDomainName", &e.VerifiedDomainName)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", e, err)
...
// MarshalJSON implements the json.Marshaller interface for type ExternalDataShareShortcutInfo.
func (e ExternalDataShareShortcutInfo) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "itemId", e.ItemID)
	populate(objectMap, "name", e.Name)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ExternalDataShareShortcutInfo.
func (e *ExternalDataShareShortcutInfo) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", e, err)
	}
...
// UnmarshalJSON implements the json.Unmarshaller interface for type GatewayAccessRuleMetadata.
func (g *GatewayAccessRuleMetadata) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", g, err)
	}
...
func (g *GatewayRoleAssignment) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "id":
			...
			delete(rawMsg, key)
		case "principal":
			g.Principal, err = unmarshalPrincipalClassification(val)
			delete(rawMsg, key)
		case "role":
...
// MarshalJSON implements the json.Marshaller interface for type GatewayStatusResponse.
func (g GatewayStatusResponse) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "errorDetails", g.ErrorDetails)
	populate(objectMap, "gatewayUpgradeState", g.GatewayUpgradeState)
	populate(objectMap, "gatewayVersion", g.GatewayVersion)
	populate(objectMap, "status", g.Status)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type GatewayStatusResponse.
func (g *GatewayStatusResponse) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", g, err)
	}
	for key, val := range rawMsg {
		...
		case "errorDetails":
			...
			delete(rawMsg, key)
		case "gatewayUpgradeState":
			err = unpopulate(val, "GatewayUpgradeState", &g.GatewayUpgradeState)
			delete(rawMsg, key)
		case "gatewayVersion":
			err = unpopulate(val, "GatewayVersion", &g.GatewayVersion)
			delete(rawMsg, key)
		case "status":
...
// MarshalJSON implements the json.Marshaller interface for type GetOneLakeSettingsResponse.
func (g GetOneLakeSettingsResponse) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "lifecycle", g.Lifecycle)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type GetOneLakeSettingsResponse.
func (g *GetOneLakeSettingsResponse) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", g, err)
	}
	for key, val := range rawMsg {
		...
		case "immutabilityPolicies":
			...
			delete(rawMsg, key)
		case "lifecycle":
			err = unpopulate(val, "Lifecycle", &g.Lifecycle)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", g, err)
...
// MarshalJSON implements the json.Marshaller interface for type GetOneLakeSettingsResponseLifecycle.
func (g GetOneLakeSettingsResponseLifecycle) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "defaultTier", g.DefaultTier)
	populate(objectMap, "policy", g.Policy)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type GetOneLakeSettingsResponseLifecycle.
func (g *GetOneLakeSettingsResponseLifecycle) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", g, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "defaultTier":
			err = unpopulate(val, "DefaultTier", &g.DefaultTier)
			delete(rawMsg, key)
		case "policy":
...
func (g GitConnection) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "gitConnectionType", g.GitConnectionType)
	populate(objectMap, "gitProviderDetails", g.GitProviderDetails)
...
func (g *GitConnection) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "gitConnectionState":
			...
			delete(rawMsg, key)
		case "gitConnectionType":
			err = unpopulate(val, "GitConnectionType", &g.GitConnectionType)
			delete(rawMsg, key)
		case "gitProviderDetails":
			g.GitProviderDetails, err = unmarshalGitProviderDetailsClassification(val)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type ImportItemDefinitionsDetails.
func (i ImportItemDefinitionsDetails) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "itemDisplayName", i.ItemDisplayName)
	populate(objectMap, "itemId", i.ItemID)
	populate(objectMap, "itemLogicalId", i.ItemLogicalID)
	populate(objectMap, "itemType", i.ItemType)
	populate(objectMap, "operationStatus", i.OperationStatus)
	populate(objectMap, "operationType", i.OperationType)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ImportItemDefinitionsDetails.
func (i *ImportItemDefinitionsDetails) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", i, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "itemDisplayName":
			err = unpopulate(val, "ItemDisplayName", &i.ItemDisplayName)
			delete(rawMsg, key)
		case "itemId":
			err = unpopulate(val, "ItemID", &i.ItemID)
			delete(rawMsg, key)
		case "itemLogicalId":
			err = unpopulate(val, "ItemLogicalID", &i.ItemLogicalID)
			delete(rawMsg, key)
		case "itemType":
		...
		case "operationStatus":
			...
			delete(rawMsg, key)
		case "operationType":
			err = unpopulate(val, "OperationType", &i.OperationType)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", i, err)
...
// MarshalJSON implements the json.Marshaller interface for type ImportOneLakeWorkspaceLifecyclePolicyRequest.
func (i ImportOneLakeWorkspaceLifecyclePolicyRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateAny(objectMap, "properties", i.Properties)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ImportOneLakeWorkspaceLifecyclePolicyRequest.
func (i *ImportOneLakeWorkspaceLifecyclePolicyRequest) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", i, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type InboundFirewallConfiguration.
func (i InboundFirewallConfiguration) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "rules", i.Rules)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type InboundFirewallConfiguration.
func (i *InboundFirewallConfiguration) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", i, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type InboundRules.
func (i InboundRules) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "publicAccessRules", i.PublicAccessRules)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type InboundRules.
func (i *InboundRules) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", i, err)
	}
	for key, val := range rawMsg {
		...
		case "publicAccessRules":
			err = unpopulate(val, "PublicAccessRules", &i.PublicAccessRules)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", i, err)
...
func (i Item) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "sensitivityLabel", i.SensitivityLabel)
...
func (i *Item) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "sensitivityLabel":
			err = unpopulate(val, "SensitivityLabel", &i.SensitivityLabel)
			delete(rawMsg, key)
		case "tags":
...
// MarshalJSON implements the json.Marshaller interface for type ItemAssignmentStatus.
func (i ItemAssignmentStatus) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "errorInfo", i.ErrorInfo)
	populate(objectMap, "itemId", i.ItemID)
	populate(objectMap, "parentItemId", i.ParentItemID)
	populate(objectMap, "status", i.Status)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ItemAssignmentStatus.
func (i *ItemAssignmentStatus) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", i, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "errorInfo":
			err = unpopulate(val, "ErrorInfo", &i.ErrorInfo)
			delete(rawMsg, key)
		case "itemId":
			err = unpopulate(val, "ItemID", &i.ItemID)
			delete(rawMsg, key)
		case "parentItemId":
			err = unpopulate(val, "ParentItemID", &i.ParentItemID)
			delete(rawMsg, key)
		case "status":
...
// MarshalJSON implements the json.Marshaller interface for type ItemCatalogEntry.
func (i ItemCatalogEntry) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	objectMap["catalogEntryType"] = CatalogEntryTypeFabricItem
	populate(objectMap, "description", i.Description)
	populate(objectMap, "displayName", i.DisplayName)
	populate(objectMap, "hierarchy", i.Hierarchy)
	populate(objectMap, "id", i.ID)
	populate(objectMap, "type", i.Type)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ItemCatalogEntry.
func (i *ItemCatalogEntry) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", i, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "catalogEntryType":
			err = unpopulate(val, "CatalogEntryType", &i.CatalogEntryType)
			delete(rawMsg, key)
		case "description":
			err = unpopulate(val, "Description", &i.Description)
			delete(rawMsg, key)
		case "displayName":
			...
			delete(rawMsg, key)
		case "hierarchy":
			err = unpopulate(val, "Hierarchy", &i.Hierarchy)
			delete(rawMsg, key)
		case "id":
			err = unpopulate(val, "ID", &i.ID)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type ItemCatalogEntryHierarchy.
func (i ItemCatalogEntryHierarchy) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "workspace", i.Workspace)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ItemCatalogEntryHierarchy.
func (i *ItemCatalogEntryHierarchy) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", i, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type ItemDefinitionIndexEntry.
func (i ItemDefinitionIndexEntry) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "id", i.ID)
	populate(objectMap, "rootPath", i.RootPath)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ItemDefinitionIndexEntry.
func (i *ItemDefinitionIndexEntry) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", i, err)
	}
	for key, val := range rawMsg {
		...
		case "id":
			...
			delete(rawMsg, key)
		case "rootPath":
			err = unpopulate(val, "RootPath", &i.RootPath)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", i, err)
...
func (i ItemSchedule) MarshalJSON() ([]byte, error) {
	...
	populateAny(objectMap, "executionData", i.ExecutionData)
	populate(objectMap, "id", i.ID)
...
func (i *ItemSchedule) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "enabled":
			...
			delete(rawMsg, key)
		case "executionData":
			err = unpopulate(val, "ExecutionData", &i.ExecutionData)
			delete(rawMsg, key)
		case "id":
			err = unpopulate(val, "ID", &i.ID)
			delete(rawMsg, key)
		case "owner":
			i.Owner, err = unmarshalPrincipalClassification(val)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", i, err)
...
// MarshalJSON implements the json.Marshaller interface for type LakehouseOneLakeDiagnosticSettingsDestination.
func (l LakehouseOneLakeDiagnosticSettingsDestination) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "lakehouse", l.Lakehouse)
	objectMap["type"] = "Lakehouse"
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type LakehouseOneLakeDiagnosticSettingsDestination.
func (l *LakehouseOneLakeDiagnosticSettingsDestination) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "lakehouse":
			l.Lakehouse, err = unmarshalItemReferenceClassification(val)
			delete(rawMsg, key)
		case "type":
...
func (l *ListConnectionsResponse) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "continuationUri":
			...
			delete(rawMsg, key)
		case "value":
			l.Value, err = unmarshalConnectionClassificationArray(val)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", l, err)
...
// MarshalJSON implements the json.Marshaller interface for type ModifyOneLakeWorkspaceDefaultTierResponse.
func (m ModifyOneLakeWorkspaceDefaultTierResponse) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "defaultTier", m.DefaultTier)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ModifyOneLakeWorkspaceDefaultTierResponse.
func (m *ModifyOneLakeWorkspaceDefaultTierResponse) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", m, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "defaultTier":
			err = unpopulate(val, "DefaultTier", &m.DefaultTier)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", m, err)
...
// MarshalJSON implements the json.Marshaller interface for type MoveItemRequest.
func (m MoveItemRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "targetFolderId", m.TargetFolderID)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type MoveItemRequest.
func (m *MoveItemRequest) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", m, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type MovedItems.
func (m MovedItems) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "value", m.Value)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type MovedItems.
func (m *MovedItems) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", m, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type NetworkRules.
func (n NetworkRules) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "defaultAction", n.DefaultAction)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type NetworkRules.
func (n *NetworkRules) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
...
// MarshalJSON implements the json.Marshaller interface for type OnPremisesGatewayConnection.
func (o OnPremisesGatewayConnection) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "connectionDetails", o.ConnectionDetails)
	populate(objectMap, "connectionRecency", o.ConnectionRecency)
	objectMap["connectivityType"] = ConnectivityTypeOnPremisesGateway
	populate(objectMap, "credentialDetails", o.CredentialDetails)
	populate(objectMap, "displayName", o.DisplayName)
	populate(objectMap, "gatewayId", o.GatewayID)
	populate(objectMap, "id", o.ID)
	populate(objectMap, "privacyLevel", o.PrivacyLevel)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type OnPremisesGatewayConnection.
func (o *OnPremisesGatewayConnection) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", o, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "connectionDetails":
			err = unpopulate(val, "ConnectionDetails", &o.ConnectionDetails)
			delete(rawMsg, key)
		case "connectionRecency":
			err = unpopulate(val, "ConnectionRecency", &o.ConnectionRecency)
			delete(rawMsg, key)
		case "connectivityType":
			err = unpopulate(val, "ConnectivityType", &o.ConnectivityType)
			delete(rawMsg, key)
		case "credentialDetails":
			err = unpopulate(val, "CredentialDetails", &o.CredentialDetails)
			delete(rawMsg, key)
		case "displayName":
			err = unpopulate(val, "DisplayName", &o.DisplayName)
			delete(rawMsg, key)
		...
		case "id":
			...
			delete(rawMsg, key)
		case "privacyLevel":
			err = unpopulate(val, "PrivacyLevel", &o.PrivacyLevel)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", o, err)
...
// MarshalJSON implements the json.Marshaller interface for type OnPremisesGatewayPersonalConnection.
func (o OnPremisesGatewayPersonalConnection) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "connectionDetails", o.ConnectionDetails)
	populate(objectMap, "connectionRecency", o.ConnectionRecency)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type OnPremisesGatewayPersonalConnection.
func (o *OnPremisesGatewayPersonalConnection) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", o, err)
	}
...
func (o OneDriveSharePoint) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "updateFabricItemSensitivity", o.UpdateFabricItemSensitivity)
	return json.Marshal(objectMap)
}
...
func (o *OneDriveSharePoint) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "subpath":
			...
			delete(rawMsg, key)
		case "updateFabricItemSensitivity":
			err = unpopulate(val, "UpdateFabricItemSensitivity", &o.UpdateFabricItemSensitivity)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", o, err)
...
// MarshalJSON implements the json.Marshaller interface for type OneLakeDiagnosticSettings.
func (o OneLakeDiagnosticSettings) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type OneLakeDiagnosticSettings.
func (o *OneLakeDiagnosticSettings) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", o, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "destination":
			o.Destination, err = unmarshalOneLakeDiagnosticSettingsDestinationInfoClassification(val)
			delete(rawMsg, key)
		case "status":
...
// MarshalJSON implements the json.Marshaller interface for type OneLakeDiagnosticSettingsDestinationInfo.
func (o OneLakeDiagnosticSettingsDestinationInfo) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	objectMap["type"] = o.Type
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type OneLakeDiagnosticSettingsDestinationInfo.
func (o *OneLakeDiagnosticSettingsDestinationInfo) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", o, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type OneLakeWorkspaceLifecyclePolicyResponse.
func (o OneLakeWorkspaceLifecyclePolicyResponse) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type OneLakeWorkspaceLifecyclePolicyResponse.
func (o *OneLakeWorkspaceLifecyclePolicyResponse) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", o, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type OutboundConnectionRule.
func (o OutboundConnectionRule) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "allowedEndpoints", o.AllowedEndpoints)
	populate(objectMap, "allowedWorkspaces", o.AllowedWorkspaces)
	populate(objectMap, "connectionType", o.ConnectionType)
	populate(objectMap, "defaultAction", o.DefaultAction)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type OutboundConnectionRule.
func (o *OutboundConnectionRule) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", o, err)
	}
	for key, val := range rawMsg {
		...
		case "allowedEndpoints":
			err = unpopulate(val, "AllowedEndpoints", &o.AllowedEndpoints)
			delete(rawMsg, key)
		case "allowedWorkspaces":
			err = unpopulate(val, "AllowedWorkspaces", &o.AllowedWorkspaces)
			delete(rawMsg, key)
		case "connectionType":
			err = unpopulate(val, "ConnectionType", &o.ConnectionType)
			delete(rawMsg, key)
		case "defaultAction":
			err = unpopulate(val, "DefaultAction", &o.DefaultAction)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", o, err)
...
// MarshalJSON implements the json.Marshaller interface for type OutboundRules.
func (o OutboundRules) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "publicAccessRules", o.PublicAccessRules)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type OutboundRules.
func (o *OutboundRules) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", o, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "publicAccessRules":
			err = unpopulate(val, "PublicAccessRules", &o.PublicAccessRules)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", o, err)
...
// MarshalJSON implements the json.Marshaller interface for type PersonalCloudConnection.
func (p PersonalCloudConnection) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "allowConnectionUsageInGateway", p.AllowConnectionUsageInGateway)
	populate(objectMap, "connectionDetails", p.ConnectionDetails)
	populate(objectMap, "connectionRecency", p.ConnectionRecency)
	objectMap["connectivityType"] = ConnectivityTypePersonalCloud
	populate(objectMap, "credentialDetails", p.CredentialDetails)
	populate(objectMap, "displayName", p.DisplayName)
	populate(objectMap, "gatewayId", p.GatewayID)
	populate(objectMap, "id", p.ID)
	populate(objectMap, "privacyLevel", p.PrivacyLevel)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type PersonalCloudConnection.
func (p *PersonalCloudConnection) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", p, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "allowConnectionUsageInGateway":
			err = unpopulate(val, "AllowConnectionUsageInGateway", &p.AllowConnectionUsageInGateway)
			delete(rawMsg, key)
		case "connectionDetails":
			err = unpopulate(val, "ConnectionDetails", &p.ConnectionDetails)
			delete(rawMsg, key)
		case "connectionRecency":
			err = unpopulate(val, "ConnectionRecency", &p.ConnectionRecency)
			delete(rawMsg, key)
		case "connectivityType":
			err = unpopulate(val, "ConnectivityType", &p.ConnectivityType)
			delete(rawMsg, key)
		case "credentialDetails":
			err = unpopulate(val, "CredentialDetails", &p.CredentialDetails)
			delete(rawMsg, key)
		case "displayName":
			err = unpopulate(val, "DisplayName", &p.DisplayName)
			delete(rawMsg, key)
		case "gatewayId":
			err = unpopulate(val, "GatewayID", &p.GatewayID)
			delete(rawMsg, key)
		case "id":
			err = unpopulate(val, "ID", &p.ID)
			delete(rawMsg, key)
		case "privacyLevel":
			err = unpopulate(val, "PrivacyLevel", &p.PrivacyLevel)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", p, err)
...
// MarshalJSON implements the json.Marshaller interface for type RecoverableItem.
func (r RecoverableItem) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "description", r.Description)
	populate(objectMap, "displayName", r.DisplayName)
	populate(objectMap, "id", r.ID)
	populate(objectMap, "parentItemId", r.ParentItemID)
	populate(objectMap, "retentionExpirationDateTime", r.RetentionExpirationDateTime)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type RecoverableItem.
func (r *RecoverableItem) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
	...
	for key, val := range rawMsg {
		...
		case "id":
			...
			delete(rawMsg, key)
		case "parentItemId":
			err = unpopulate(val, "ParentItemID", &r.ParentItemID)
			delete(rawMsg, key)
		case "retentionExpirationDateTime":
			err = unpopulate(val, "RetentionExpirationDateTime", &r.RetentionExpirationDateTime)
			delete(rawMsg, key)
		case "tags":
...
// MarshalJSON implements the json.Marshaller interface for type RecoverableItems.
func (r RecoverableItems) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type RecoverableItems.
func (r *RecoverableItems) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", r, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type RelationsEdge.
func (r RelationsEdge) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "dependentOnItemId", r.DependentOnItemID)
	populate(objectMap, "itemId", r.ItemID)
	populate(objectMap, "relationType", r.RelationType)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type RelationsEdge.
func (r *RelationsEdge) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", r, err)
	}
	for key, val := range rawMsg {
		var err error
		switch key {
		case "dependentOnItemId":
			err = unpopulate(val, "DependentOnItemID", &r.DependentOnItemID)
			delete(rawMsg, key)
		case "itemId":
			err = unpopulate(val, "ItemID", &r.ItemID)
			delete(rawMsg, key)
		case "relationType":
			err = unpopulate(val, "RelationType", &r.RelationType)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", r, err)
...
// MarshalJSON implements the json.Marshaller interface for type RelationsRelatedItem.
func (r RelationsRelatedItem) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "displayName", r.DisplayName)
	populate(objectMap, "id", r.ID)
	populate(objectMap, "type", r.Type)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type RelationsRelatedItem.
func (r *RelationsRelatedItem) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", r, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type RelationsResponse.
func (r RelationsResponse) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "items", r.Items)
	populate(objectMap, "relations", r.Relations)
	populate(objectMap, "workspaces", r.Workspaces)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type RelationsResponse.
func (r *RelationsResponse) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", r, err)
	}
	for key, val := range rawMsg {
		...
		case "items":
			...
			delete(rawMsg, key)
		case "relations":
			err = unpopulate(val, "Relations", &r.Relations)
			delete(rawMsg, key)
		case "workspaces":
			err = unpopulate(val, "Workspaces", &r.Workspaces)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", r, err)
...
// MarshalJSON implements the json.Marshaller interface for type RelationsWorkspace.
func (r RelationsWorkspace) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "displayName", r.DisplayName)
	populate(objectMap, "id", r.ID)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type RelationsWorkspace.
func (r *RelationsWorkspace) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", r, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type RowConstraint.
func (r RowConstraint) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "tablePath", r.TablePath)
	populate(objectMap, "value", r.Value)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type RowConstraint.
func (r *RowConstraint) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", r, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "tablePath":
			err = unpopulate(val, "TablePath", &r.TablePath)
			delete(rawMsg, key)
		case "value":
			err = unpopulate(val, "Value", &r.Value)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type ShareableCloudConnection.
func (s ShareableCloudConnection) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "allowConnectionUsageInGateway", s.AllowConnectionUsageInGateway)
	populate(objectMap, "allowUsageInUserControlledCode", s.AllowUsageInUserControlledCode)
	populate(objectMap, "connectionDetails", s.ConnectionDetails)
	populate(objectMap, "connectionRecency", s.ConnectionRecency)
	objectMap["connectivityType"] = ConnectivityTypeShareableCloud
	populate(objectMap, "credentialDetails", s.CredentialDetails)
	populate(objectMap, "displayName", s.DisplayName)
	populate(objectMap, "gatewayId", s.GatewayID)
	populate(objectMap, "id", s.ID)
	populate(objectMap, "privacyLevel", s.PrivacyLevel)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ShareableCloudConnection.
func (s *ShareableCloudConnection) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "allowConnectionUsageInGateway":
			err = unpopulate(val, "AllowConnectionUsageInGateway", &s.AllowConnectionUsageInGateway)
			delete(rawMsg, key)
		case "allowUsageInUserControlledCode":
			err = unpopulate(val, "AllowUsageInUserControlledCode", &s.AllowUsageInUserControlledCode)
			delete(rawMsg, key)
		case "connectionDetails":
			err = unpopulate(val, "ConnectionDetails", &s.ConnectionDetails)
			delete(rawMsg, key)
		case "connectionRecency":
			err = unpopulate(val, "ConnectionRecency", &s.ConnectionRecency)
			delete(rawMsg, key)
		case "connectivityType":
			err = unpopulate(val, "ConnectivityType", &s.ConnectivityType)
			delete(rawMsg, key)
		case "credentialDetails":
			err = unpopulate(val, "CredentialDetails", &s.CredentialDetails)
			delete(rawMsg, key)
		case "displayName":
			err = unpopulate(val, "DisplayName", &s.DisplayName)
			delete(rawMsg, key)
		case "gatewayId":
			err = unpopulate(val, "GatewayID", &s.GatewayID)
			delete(rawMsg, key)
		case "id":
			err = unpopulate(val, "ID", &s.ID)
			delete(rawMsg, key)
		case "privacyLevel":
			err = unpopulate(val, "PrivacyLevel", &s.PrivacyLevel)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", s, err)
...
func (s Shortcut) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "transform", s.Transform)
	return json.Marshal(objectMap)
}
...
func (s *Shortcut) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "target":
			...
			delete(rawMsg, key)
		case "transform":
			s.Transform, err = unmarshalTransformClassification(val)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", s, err)
...
// MarshalJSON implements the json.Marshaller interface for type ShortcutCreationPayload.
func (s ShortcutCreationPayload) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "createShortcutRequests", s.CreateShortcutRequests)
	populate(objectMap, "path", s.Path)
	objectMap["payloadType"] = ExternalDataShareAcceptRequestPayloadTypeShortcutCreation
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type ShortcutCreationPayload.
func (s *ShortcutCreationPayload) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "createShortcutRequests":
			err = unpopulate(val, "CreateShortcutRequests", &s.CreateShortcutRequests)
			delete(rawMsg, key)
		case "path":
			err = unpopulate(val, "Path", &s.Path)
			delete(rawMsg, key)
		case "payloadType":
			err = unpopulate(val, "PayloadType", &s.PayloadType)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", s, err)
...
// MarshalJSON implements the json.Marshaller interface for type ShortcutTransformFlagged.
func (s ShortcutTransformFlagged) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "isShortcutTransform", s.IsShortcutTransform)
	populate(objectMap, "name", s.Name)
	populate(objectMap, "path", s.Path)
	populate(objectMap, "target", s.Target)
	populate(objectMap, "transform", s.Transform)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ShortcutTransformFlagged.
func (s *ShortcutTransformFlagged) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
	for key, val := range rawMsg {
		var err error
		switch key {
		case "isShortcutTransform":
			err = unpopulate(val, "IsShortcutTransform", &s.IsShortcutTransform)
			delete(rawMsg, key)
		case "name":
			err = unpopulate(val, "Name", &s.Name)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type StreamingVirtualNetworkGateway.
func (s StreamingVirtualNetworkGateway) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "displayName", s.DisplayName)
	populate(objectMap, "id", s.ID)
	objectMap["type"] = GatewayTypeStreamingVirtualNetwork
	populate(objectMap, "virtualNetworkAzureResource", s.VirtualNetworkAzureResource)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type StreamingVirtualNetworkGateway.
func (s *StreamingVirtualNetworkGateway) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
	for key, val := range rawMsg {
		...
		case "type":
			...
			delete(rawMsg, key)
		case "virtualNetworkAzureResource":
			err = unpopulate(val, "VirtualNetworkAzureResource", &s.VirtualNetworkAzureResource)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", s, err)
...
// MarshalJSON implements the json.Marshaller interface for type StreamingVirtualNetworkGatewayConnection.
func (s StreamingVirtualNetworkGatewayConnection) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "connectionDetails", s.ConnectionDetails)
	populate(objectMap, "connectionRecency", s.ConnectionRecency)
	objectMap["connectivityType"] = ConnectivityTypeStreamingVirtualNetworkGateway
...
// UnmarshalJSON implements the json.Unmarshaller interface for type StreamingVirtualNetworkGatewayConnection.
func (s *StreamingVirtualNetworkGatewayConnection) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", s, err)
	}
...
func (t *Tag) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "id":
			...
			delete(rawMsg, key)
		case "scope":
			t.Scope, err = unmarshalTagScopeClassification(val)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", t, err)
...
// MarshalJSON implements the json.Marshaller interface for type TagScope.
...
// UnmarshalJSON implements the json.Unmarshaller interface for type TagScope.
...
// MarshalJSON implements the json.Marshaller interface for type TenantTagScope.
func (t TenantTagScope) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	objectMap["type"] = TagScopeTypeTenant
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type TenantTagScope.
func (t *TenantTagScope) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", t, err)
	}
...
func (t Transform) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "includeSubfolders", t.IncludeSubfolders)
	objectMap["type"] = t.Type
	return json.Marshal(objectMap)
}
...
func (t *Transform) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "includeSubfolders":
			err = unpopulate(val, "IncludeSubfolders", &t.IncludeSubfolders)
			delete(rawMsg, key)
		case "type":
			err = unpopulate(val, "Type", &t.Type)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type UnapplyTagsRequest.
func (u UnapplyTagsRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "tags", u.Tags)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type UnapplyTagsRequest.
func (u *UnapplyTagsRequest) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
...
// MarshalJSON implements the json.Marshaller interface for type UnapplyWorkspaceTagsRequest.
func (u UnapplyWorkspaceTagsRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "tags", u.Tags)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type UnapplyWorkspaceTagsRequest.
func (u *UnapplyWorkspaceTagsRequest) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", u, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type UpdateItemIdentityRequest.
func (u UpdateItemIdentityRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "assignmentType", u.AssignmentType)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type UpdateItemIdentityRequest.
func (u *UpdateItemIdentityRequest) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", u, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "assignmentType":
			err = unpopulate(val, "AssignmentType", &u.AssignmentType)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", u, err)
...
// MarshalJSON implements the json.Marshaller interface for type UpdateItemIdentityResponse.
func (u UpdateItemIdentityResponse) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "assignmentStatus", u.AssignmentStatus)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type UpdateItemIdentityResponse.
func (u *UpdateItemIdentityResponse) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", u, err)
	}
	for key, val := range rawMsg {
		...
		case "assignmentStatus":
			err = unpopulate(val, "AssignmentStatus", &u.AssignmentStatus)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", u, err)
...
func (u UpdatePersonalCloudConnectionRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "allowConnectionUsageInGateway", u.AllowConnectionUsageInGateway)
	objectMap["connectivityType"] = ConnectivityTypePersonalCloud
	populate(objectMap, "credentialDetails", u.CredentialDetails)
	populate(objectMap, "privacyLevel", u.PrivacyLevel)
	return json.Marshal(objectMap)
...
func (u *UpdatePersonalCloudConnectionRequest) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "allowConnectionUsageInGateway":
			err = unpopulate(val, "AllowConnectionUsageInGateway", &u.AllowConnectionUsageInGateway)
			delete(rawMsg, key)
		case "connectivityType":
			err = unpopulate(val, "ConnectivityType", &u.ConnectivityType)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type UpdateStreamingVirtualNetworkGatewayConnectionRequest.
func (u UpdateStreamingVirtualNetworkGatewayConnectionRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	objectMap["connectivityType"] = ConnectivityTypeStreamingVirtualNetworkGateway
	populate(objectMap, "credentialDetails", u.CredentialDetails)
	populate(objectMap, "displayName", u.DisplayName)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type UpdateStreamingVirtualNetworkGatewayConnectionRequest.
func (u *UpdateStreamingVirtualNetworkGatewayConnectionRequest) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", u, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type UpdateStreamingVirtualNetworkGatewayRequest.
func (u UpdateStreamingVirtualNetworkGatewayRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "displayName", u.DisplayName)
	objectMap["type"] = GatewayTypeStreamingVirtualNetwork
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type UpdateStreamingVirtualNetworkGatewayRequest.
func (u *UpdateStreamingVirtualNetworkGatewayRequest) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", u, err)
	}
...
func (u UpdateVirtualNetworkGatewayRequest) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "maxMemberGatewayCount", u.MaxMemberGatewayCount)
	populate(objectMap, "minMemberGatewayCount", u.MinMemberGatewayCount)
...
func (u *UpdateVirtualNetworkGatewayRequest) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "inactivityMinutesBeforeSleep":
			...
			delete(rawMsg, key)
		case "maxMemberGatewayCount":
			err = unpopulate(val, "MaxMemberGatewayCount", &u.MaxMemberGatewayCount)
			delete(rawMsg, key)
		case "minMemberGatewayCount":
			err = unpopulate(val, "MinMemberGatewayCount", &u.MinMemberGatewayCount)
			delete(rawMsg, key)
		case "numberOfMemberGateways":
...
func (v VirtualNetworkGateway) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "maxMemberGatewayCount", v.MaxMemberGatewayCount)
	populate(objectMap, "minMemberGatewayCount", v.MinMemberGatewayCount)
...
func (v *VirtualNetworkGateway) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "inactivityMinutesBeforeSleep":
			...
			delete(rawMsg, key)
		case "maxMemberGatewayCount":
			err = unpopulate(val, "MaxMemberGatewayCount", &v.MaxMemberGatewayCount)
			delete(rawMsg, key)
		case "minMemberGatewayCount":
			err = unpopulate(val, "MinMemberGatewayCount", &v.MinMemberGatewayCount)
			delete(rawMsg, key)
		case "numberOfMemberGateways":
...
func (v VirtualNetworkGatewayConnection) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "connectionDetails", v.ConnectionDetails)
	populate(objectMap, "connectionRecency", v.ConnectionRecency)
	objectMap["connectivityType"] = ConnectivityTypeVirtualNetworkGateway
	populate(objectMap, "credentialDetails", v.CredentialDetails)
	populate(objectMap, "displayName", v.DisplayName)
	populate(objectMap, "gatewayId", v.GatewayID)
	populate(objectMap, "id", v.ID)
	populate(objectMap, "privacyLevel", v.PrivacyLevel)
	return json.Marshal(objectMap)
}
...
func (v *VirtualNetworkGatewayConnection) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "connectionDetails":
			err = unpopulate(val, "ConnectionDetails", &v.ConnectionDetails)
			delete(rawMsg, key)
		case "connectionRecency":
			err = unpopulate(val, "ConnectionRecency", &v.ConnectionRecency)
			delete(rawMsg, key)
		case "connectivityType":
			err = unpopulate(val, "ConnectivityType", &v.ConnectivityType)
			delete(rawMsg, key)
		case "credentialDetails":
			err = unpopulate(val, "CredentialDetails", &v.CredentialDetails)
			delete(rawMsg, key)
		case "displayName":
			err = unpopulate(val, "DisplayName", &v.DisplayName)
			delete(rawMsg, key)
		case "gatewayId":
			err = unpopulate(val, "GatewayID", &v.GatewayID)
			delete(rawMsg, key)
		case "id":
			err = unpopulate(val, "ID", &v.ID)
			delete(rawMsg, key)
		case "privacyLevel":
			err = unpopulate(val, "PrivacyLevel", &v.PrivacyLevel)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", v, err)
...
func (w Workspace) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "apiEndpoint", w.APIEndpoint)
...
func (w *Workspace) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "apiEndpoint":
			err = unpopulate(val, "APIEndpoint", &w.APIEndpoint)
			delete(rawMsg, key)
		case "capacityId":
...
// MarshalJSON implements the json.Marshaller interface for type WorkspaceEncryptionDetail.
func (w WorkspaceEncryptionDetail) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "encryptionDetail", w.EncryptionDetail)
	populate(objectMap, "previousEncryptionDetail", w.PreviousEncryptionDetail)
	populate(objectMap, "workspaceEncryptionItemsDetails", w.WorkspaceEncryptionItemsDetails)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type WorkspaceEncryptionDetail.
func (w *WorkspaceEncryptionDetail) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", w, err)
	}
	for key, val := range rawMsg {
		var err error
		switch key {
		case "encryptionDetail":
			err = unpopulate(val, "EncryptionDetail", &w.EncryptionDetail)
			delete(rawMsg, key)
		case "previousEncryptionDetail":
			err = unpopulate(val, "PreviousEncryptionDetail", &w.PreviousEncryptionDetail)
			delete(rawMsg, key)
		case "workspaceEncryptionItemsDetails":
			err = unpopulate(val, "WorkspaceEncryptionItemsDetails", &w.WorkspaceEncryptionItemsDetails)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", w, err)
...
// MarshalJSON implements the json.Marshaller interface for type WorkspaceEncryptionItem.
func (w WorkspaceEncryptionItem) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "displayName", w.DisplayName)
	populate(objectMap, "id", w.ID)
	populate(objectMap, "type", w.Type)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type WorkspaceEncryptionItem.
func (w *WorkspaceEncryptionItem) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", w, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type WorkspaceEncryptionItemsDetail.
func (w WorkspaceEncryptionItemsDetail) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "encryptionStatus", w.EncryptionStatus)
	populate(objectMap, "items", w.Items)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type WorkspaceEncryptionItemsDetail.
func (w *WorkspaceEncryptionItemsDetail) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", w, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "encryptionStatus":
			err = unpopulate(val, "EncryptionStatus", &w.EncryptionStatus)
			delete(rawMsg, key)
		case "items":
...
// MarshalJSON implements the json.Marshaller interface for type WorkspaceInboundAzureResourceRule.
func (w WorkspaceInboundAzureResourceRule) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "displayName", w.DisplayName)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type WorkspaceInboundAzureResourceRule.
func (w *WorkspaceInboundAzureResourceRule) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", w, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type WorkspaceInboundAzureResourceRules.
func (w WorkspaceInboundAzureResourceRules) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "rules", w.Rules)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type WorkspaceInboundAzureResourceRules.
func (w *WorkspaceInboundAzureResourceRules) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", w, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "rules":
			err = unpopulate(val, "Rules", &w.Rules)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", w, err)
...
// MarshalJSON implements the json.Marshaller interface for type WorkspaceInboundExternalDataSharesPolicy.
func (w WorkspaceInboundExternalDataSharesPolicy) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "defaultAction", w.DefaultAction)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type WorkspaceInboundExternalDataSharesPolicy.
func (w *WorkspaceInboundExternalDataSharesPolicy) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", w, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "defaultAction":
			err = unpopulate(val, "DefaultAction", &w.DefaultAction)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", w, err)
...
// MarshalJSON implements the json.Marshaller interface for type WorkspaceNetworkingCommunicationPolicy.
func (w WorkspaceNetworkingCommunicationPolicy) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "inbound", w.Inbound)
	populate(objectMap, "outbound", w.Outbound)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type WorkspaceNetworkingCommunicationPolicy.
func (w *WorkspaceNetworkingCommunicationPolicy) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", w, err)
	}
	for key, val := range rawMsg {
		...
		switch key {
		case "inbound":
			err = unpopulate(val, "Inbound", &w.Inbound)
			delete(rawMsg, key)
		case "outbound":
			err = unpopulate(val, "Outbound", &w.Outbound)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", w, err)
...
// MarshalJSON implements the json.Marshaller interface for type WorkspaceOutboundConnections.
func (w WorkspaceOutboundConnections) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "defaultAction", w.DefaultAction)
	populate(objectMap, "rules", w.Rules)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type WorkspaceOutboundConnections.
func (w *WorkspaceOutboundConnections) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", w, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type WorkspaceOutboundGateways.
func (w WorkspaceOutboundGateways) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "allowedGateways", w.AllowedGateways)
	populate(objectMap, "defaultAction", w.DefaultAction)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type WorkspaceOutboundGateways.
func (w *WorkspaceOutboundGateways) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", w, err)
	}
	for key, val := range rawMsg {
		var err error
		switch key {
		case "allowedGateways":
			err = unpopulate(val, "AllowedGateways", &w.AllowedGateways)
			delete(rawMsg, key)
		case "defaultAction":
			err = unpopulate(val, "DefaultAction", &w.DefaultAction)
			delete(rawMsg, key)
...
// MarshalJSON implements the json.Marshaller interface for type WorkspaceRelation.
func (w WorkspaceRelation) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "id", w.ID)
	populate(objectMap, "relatedWorkspaceId", w.RelatedWorkspaceID)
	populate(objectMap, "relationType", w.RelationType)
	populate(objectMap, "workspaceId", w.WorkspaceID)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type WorkspaceRelation.
func (w *WorkspaceRelation) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", w, err)
	}
	for key, val := range rawMsg {
		...
		case "id":
			...
			delete(rawMsg, key)
		case "relatedWorkspaceId":
			err = unpopulate(val, "RelatedWorkspaceID", &w.RelatedWorkspaceID)
			delete(rawMsg, key)
		case "relationType":
			err = unpopulate(val, "RelationType", &w.RelationType)
			delete(rawMsg, key)
		case "workspaceId":
...
// MarshalJSON implements the json.Marshaller interface for type WorkspaceRelations.
func (w WorkspaceRelations) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type WorkspaceRelations.
func (w *WorkspaceRelations) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", w, err)
	}
...
func (w *WorkspaceRoleAssignment) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "id":
			...
			delete(rawMsg, key)
		case "principal":
			w.Principal, err = unmarshalPrincipalClassification(val)
			delete(rawMsg, key)
		case "role":
