...
func (testsuite *FakeTestSuite) TestItems_CreateItem() {
	...
	// From example
	ctx = runtime.WithHTTPHeader(testsuite.ctx, map[string][]string{
		"example-id": {"Create an item with sensitivity label strategy example"},
	})
	exampleWorkspaceID = "cfafbeb1-8037-4d0c-896e-a46fb27ff229"
	exampleCreateItemRequest = core.CreateItemRequest{
		Type:        to.Ptr(core.ItemTypeLakehouse),
...
func (testsuite *FakeTestSuite) TestItems_BulkExportItemDefinitionsBeta() {
	// From example
	ctx := runtime.WithHTTPHeader(testsuite.ctx, map[string][]string{
		"example-id": {"Bulk export all supported item definitions in workspace example"},
	})
	var exampleWorkspaceID string
	var exampleBeta bool
	exampleWorkspaceID = "9d19eb70-17d7-43b5-b6ce-943658e246be"
	exampleBeta = true

	exampleRes := core.BulkExportItemDefinitionsResponse{
	...
	testsuite.serverFactory.ItemsServer.BeginBulkExportItemDefinitionsBeta = func(ctx context.Context, workspaceID string, beta bool, options *core.ItemsClientBeginBulkExportItemDefinitionsBetaOptions) (resp azfake.PollerResponder[core.ItemsClientBulkExportItemDefinitionsBetaResponse], errResp azfake.ErrorResponder) {
		testsuite.Require().Equal(exampleWorkspaceID, workspaceID)
		testsuite.Require().Equal(exampleBeta, beta)
		resp = azfake.PollerResponder[core.ItemsClientBulkExportItemDefinitionsBetaResponse]{}
		resp.SetTerminalResponse(http.StatusOK, core.ItemsClientBulkExportItemDefinitionsBetaResponse{BulkExportItemDefinitionsResponse: exampleRes}, nil)
		return
	}

	client := testsuite.clientFactory.NewItemsClient()
	poller, err := client.BeginBulkExportItemDefinitionsBeta(ctx, exampleWorkspaceID, exampleBeta, &core.ItemsClientBeginBulkExportItemDefinitionsBetaOptions{BulkExportItemDefinitionsRequest: &core.BulkExportItemDefinitionsRequest{
	...
	res, err := poller.PollUntilDone(ctx, nil)
	testsuite.Require().NoError(err, "Failed to get LRO result for example ")
	testsuite.Require().True(reflect.DeepEqual(exampleRes, res.BulkExportItemDefinitionsResponse))

	// From example
	ctx = runtime.WithHTTPHeader(testsuite.ctx, map[string][]string{
		"example-id": {"Bulk export selected item definitions example"},
	})
	exampleWorkspaceID = "9d19eb70-17d7-43b5-b6ce-943658e246be"
	exampleBeta = true
...
func (testsuite *FakeTestSuite) TestItems_BulkImportItemDefinitionsBeta() {
	// From example
	ctx := runtime.WithHTTPHeader(testsuite.ctx, map[string][]string{
		"example-id": {"Bulk import item definitions example"},
	})
	var exampleWorkspaceID string
	var exampleBeta bool
	exampleWorkspaceID = "24d305d1-9db8-4785-b038-714e07e7394f"
	exampleBeta = true

	exampleRes := core.BulkImportItemDefinitionsResponse{
	...
	testsuite.serverFactory.ItemsServer.BeginBulkImportItemDefinitionsBeta = func(ctx context.Context, workspaceID string, beta bool, options *core.ItemsClientBeginBulkImportItemDefinitionsBetaOptions) (resp azfake.PollerResponder[core.ItemsClientBulkImportItemDefinitionsBetaResponse], errResp azfake.ErrorResponder) {
		testsuite.Require().Equal(exampleWorkspaceID, workspaceID)
		testsuite.Require().Equal(exampleBeta, beta)
		resp = azfake.PollerResponder[core.ItemsClientBulkImportItemDefinitionsBetaResponse]{}
		resp.SetTerminalResponse(http.StatusOK, core.ItemsClientBulkImportItemDefinitionsBetaResponse{BulkImportItemDefinitionsResponse: exampleRes}, nil)
		return
	}

	client := testsuite.clientFactory.NewItemsClient()
	poller, err := client.BeginBulkImportItemDefinitionsBeta(ctx, exampleWorkspaceID, exampleBeta, &core.ItemsClientBeginBulkImportItemDefinitionsBetaOptions{BulkImportItemDefinitionsRequest: &core.BulkImportItemDefinitionsRequest{
		DefinitionParts: []core.ItemDefinitionPart{
			{
				Path:        to.Ptr("/Folder1/Folder2/MyReport.Report/.platform"),
				Payload:     to.Ptr(""),
	...
	res, err := poller.PollUntilDone(ctx, nil)
	testsuite.Require().NoError(err, "Failed to get LRO result for example ")
	testsuite.Require().True(reflect.DeepEqual(exampleRes, res.BulkImportItemDefinitionsResponse))
}
...
func (testsuite *FakeTestSuite) TestJobScheduler_RunOnDemandItemJob() {
	...
	// From example
	ctx = runtime.WithHTTPHeader(testsuite.ctx, map[string][]string{
		"example-id": {"Run item job instance with request body containing both executionData and parameters example"},
	})
	exampleWorkspaceID = "a0a0a0a0-bbbb-cccc-dddd-e1e1e1e1e1e1"
	exampleItemID = "dddddddd-9999-0000-1111-eeeeeeeeeeee"
	...
	// From example
	ctx = runtime.WithHTTPHeader(testsuite.ctx, map[string][]string{
		"example-id": {"Run item job instance with request body containing parameters example"},
	})
	exampleWorkspaceID = "a0a0a0a0-bbbb-cccc-dddd-e1e1e1e1e1e1"
	exampleItemID = "dddddddd-9999-0000-1111-eeeeeeeeeeee"
	exampleJobType = "Execute"
...
func (testsuite *FakeTestSuite) TestOneLakeDataAccessSecurity_CreateOrUpdateSingleDataAccessRole() {
	// From example
	ctx := runtime.WithHTTPHeader(testsuite.ctx, map[string][]string{
		"example-id": {"Create or update single data access role example"},
	})
	var exampleWorkspaceID string
	var exampleItemID string
	...
	testsuite.serverFactory.OneLakeDataAccessSecurityServer.CreateOrUpdateSingleDataAccessRole = func(ctx context.Context, workspaceID string, itemID string, createOrUpdateSingleDataAccessRoleRequest core.CreateOrUpdateSingleDataAccessRoleRequest, options *core.OneLakeDataAccessSecurityClientCreateOrUpdateSingleDataAccessRoleOptions) (resp azfake.Responder[core.OneLakeDataAccessSecurityClientCreateOrUpdateSingleDataAccessRoleResponse], errResp azfake.ErrorResponder) {
		...
		resp = azfake.Responder[core.OneLakeDataAccessSecurityClientCreateOrUpdateSingleDataAccessRoleResponse]{}
		resp.SetResponse(http.StatusOK, core.OneLakeDataAccessSecurityClientCreateOrUpdateSingleDataAccessRoleResponse{}, nil)
		return
	}

	client := testsuite.clientFactory.NewOneLakeDataAccessSecurityClient()
	_, err = client.CreateOrUpdateSingleDataAccessRole(ctx, exampleWorkspaceID, exampleItemID, exampleCreateOrUpdateSingleDataAccessRoleRequest, &core.OneLakeDataAccessSecurityClientCreateOrUpdateSingleDataAccessRoleOptions{DataAccessRoleConflictPolicy: to.Ptr(core.DataAccessRoleConflictPolicyOverwrite),
		IfMatch:     nil,
		IfNoneMatch: nil,
	})
	testsuite.Require().NoError(err, "Failed to get result for example ")
...
func (testsuite *FakeTestSuite) TestOneLakeDataAccessSecurity_GetDataAccessRole() {
	// From example
	ctx := runtime.WithHTTPHeader(testsuite.ctx, map[string][]string{
		"example-id": {"Get data access role example"},
	})
	var exampleWorkspaceID string
	var exampleItemID string
	...
	exampleWorkspaceID = "cfafbeb1-8037-4d0c-896e-a46fb27ff222"
	exampleItemID = "25bac802-080d-4f73-8a42-1b406eb1fceb"
	exampleRoleName = "DefaultReader"

	exampleRes := core.DataAccessRoleBase{
		Name: to.Ptr("DefaultReader"),
		DecisionRules: []core.DecisionRule{
			{
				Constraints: &core.DecisionRuleConstraints{
	...
	testsuite.serverFactory.OneLakeDataAccessSecurityServer.GetDataAccessRole = func(ctx context.Context, workspaceID string, itemID string, roleName string, options *core.OneLakeDataAccessSecurityClientGetDataAccessRoleOptions) (resp azfake.Responder[core.OneLakeDataAccessSecurityClientGetDataAccessRoleResponse], errResp azfake.ErrorResponder) {
		testsuite.Require().Equal(exampleWorkspaceID, workspaceID)
		testsuite.Require().Equal(exampleItemID, itemID)
		testsuite.Require().Equal(exampleRoleName, roleName)
		resp = azfake.Responder[core.OneLakeDataAccessSecurityClientGetDataAccessRoleResponse]{}
		resp.SetResponse(http.StatusOK, core.OneLakeDataAccessSecurityClientGetDataAccessRoleResponse{DataAccessRoleBase: exampleRes}, nil)
		return
	}

	client := testsuite.clientFactory.NewOneLakeDataAccessSecurityClient()
	res, err := client.GetDataAccessRole(ctx, exampleWorkspaceID, exampleItemID, exampleRoleName, &core.OneLakeDataAccessSecurityClientGetDataAccessRoleOptions{IfMatch: nil,
		IfNoneMatch: nil,
	})
	testsuite.Require().NoError(err, "Failed to get result for example ")
	testsuite.Require().True(reflect.DeepEqual(exampleRes, res.DataAccessRoleBase))
}

func (testsuite *FakeTestSuite) TestOneLakeDataAccessSecurity_DeleteDataAccessRole() {
	// From example
	ctx := runtime.WithHTTPHeader(testsuite.ctx, map[string][]string{
		"example-id": {"Delete data access role example"},
	})
	var exampleWorkspaceID string
	var exampleItemID string
	var exampleRoleName string
	...
	testsuite.serverFactory.OneLakeDataAccessSecurityServer.DeleteDataAccessRole = func(ctx context.Context, workspaceID string, itemID string, roleName string, options *core.OneLakeDataAccessSecurityClientDeleteDataAccessRoleOptions) (resp azfake.Responder[core.OneLakeDataAccessSecurityClientDeleteDataAccessRoleResponse], errResp azfake.ErrorResponder) {
		testsuite.Require().Equal(exampleWorkspaceID, workspaceID)
		testsuite.Require().Equal(exampleItemID, itemID)
		testsuite.Require().Equal(exampleRoleName, roleName)
		resp = azfake.Responder[core.OneLakeDataAccessSecurityClientDeleteDataAccessRoleResponse]{}
		resp.SetResponse(http.StatusOK, core.OneLakeDataAccessSecurityClientDeleteDataAccessRoleResponse{}, nil)
		return
	}

	client := testsuite.clientFactory.NewOneLakeDataAccessSecurityClient()
	_, err = client.DeleteDataAccessRole(ctx, exampleWorkspaceID, exampleItemID, exampleRoleName, nil)
	testsuite.Require().NoError(err, "Failed to get result for example ")
}
