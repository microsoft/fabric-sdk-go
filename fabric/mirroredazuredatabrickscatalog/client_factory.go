...
func (c *ClientFactory) NewDiscoveryClient() *DiscoveryClient {
	return &DiscoveryClient{
		internal: c.internal.WithClientName("mirroredazuredatabrickscatalog.DiscoveryClient"),
		endpoint: c.endpoint,
	}
}
...
func (c *ClientFactory) NewItemsClient() *ItemsClient {
	return &ItemsClient{
		internal: c.internal.WithClientName("mirroredazuredatabrickscatalog.ItemsClient"),
		endpoint: c.endpoint,
	}
}
...
func (c *ClientFactory) NewRefreshClient() *RefreshClient {
	return &RefreshClient{
		internal: c.internal.WithClientName("mirroredazuredatabrickscatalog.RefreshClient"),
		endpoint: c.endpoint,
	}
}
