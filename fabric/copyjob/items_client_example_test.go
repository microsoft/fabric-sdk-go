...
func ExampleItemsClient_NewListCopyJobsPager() {
	...
	pager := clientFactory.NewItemsClient().NewListCopyJobsPager("cfafbeb1-8037-4d0c-896e-a46fb27ff229", &copyjob.ItemsClientListCopyJobsOptions{Recursive: nil,
		RootFolderID:      nil,
...
// Generated from example definition
func ExampleItemsClient_DeleteCopyJob_deleteACopyJobExample() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	_, err = clientFactory.NewItemsClient().DeleteCopyJob(ctx, "cfafbeb1-8037-4d0c-896e-a46fb27ff229", "5b218778-e7a5-4d73-8187-f10824047715", &copyjob.ItemsClientDeleteCopyJobOptions{HardDelete: nil})
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
}
...
// Generated from example definition
func ExampleItemsClient_DeleteCopyJob_hardDeleteACopyJobExample() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	_, err = clientFactory.NewItemsClient().DeleteCopyJob(ctx, "cfafbeb1-8037-4d0c-896e-a46fb27ff229", "5b218778-e7a5-4d73-8187-f10824047715", &copyjob.ItemsClientDeleteCopyJobOptions{HardDelete: to.Ptr(true)})
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
}
