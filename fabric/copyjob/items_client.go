...
func (client *ItemsClient) deleteCopyJobCreateRequest(ctx context.Context, workspaceID string, copyJobID string, options *ItemsClientDeleteCopyJobOptions) (*policy.Request, error) {
