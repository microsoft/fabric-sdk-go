...
func ExampleLivySessionsClient_NewListLivySessionsPager() {
	...
	pager := clientFactory.NewLivySessionsClient().NewListLivySessionsPager("f8113ba8-dd81-443e-811a-b385340f3f05", "8cee7699-2e81-4121-9a53-cc9025046193", &lakehouse.LivySessionsClientListLivySessionsOptions{ContinuationToken: nil})
	for pager.More() {
...
func ExampleLivySessionsClient_NewListLivySessionsBetaPager() {
	...
	pager := clientFactory.NewLivySessionsClient().NewListLivySessionsBetaPager("f8113ba8-dd81-443e-811a-b385340f3f05", "8cee7699-2e81-4121-9a53-cc9025046193", true, &lakehouse.LivySessionsClientListLivySessionsBetaOptions{SubmittedDateTime: nil,
		EndDateTime:       nil,
		SubmitterID:       nil,
		State:             nil,
...
func ExampleLivySessionsClient_GetLivySession() {
	...
	// res.LivySession = lakehouse.LivySession{
	// 	AttemptNumber: to.Ptr[int32](1),
	// 	CancellationReason: to.Ptr("User cancelled the Spark batch"),
	// 	CapacityID: to.Ptr("3c0cd366-dc28-4b6d-a525-4d415a8666e7"),
	// 	CreatorItem: &lakehouse.ItemReferenceByID{
