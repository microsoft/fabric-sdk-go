...
func (c *ClientFactory) NewBackgroundJobsClient() *BackgroundJobsClient {
	return &BackgroundJobsClient{
		internal: c.internal.WithClientName("lakehouse.BackgroundJobsClient"),
		endpoint: c.endpoint,
	}
}
...
func (c *ClientFactory) NewItemsClient() *ItemsClient {
	return &ItemsClient{
		internal: c.internal.WithClientName("lakehouse.ItemsClient"),
		endpoint: c.endpoint,
	}
}
...
func (c *ClientFactory) NewTablesClient() *TablesClient {
	return &TablesClient{
		internal: c.internal.WithClientName("lakehouse.TablesClient"),
		endpoint: c.endpoint,
	}
}
