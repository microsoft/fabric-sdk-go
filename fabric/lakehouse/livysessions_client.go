...
// PERMISSIONS The caller must have read permissions for the lakehouse.
// REQUIRED DELEGATED SCOPES Lakehouse.Read.All or Lakehouse.ReadWrite.All or Item.Read.All or Item.ReadWrite.All
// MICROSOFT ENTRA SUPPORTED IDENTITIES This API supports the Microsoft identities [/rest/api/fabric/articles/identity-support]
// listed in this section.
// | Identity | Support | |-|-| | User | Yes | | Service principal [/entra/identity-platform/app-objects-and-service-principals#service-principal-object]
...
//     method.
func (client *LivySessionsClient) NewListLivySessionsPreviewPager(workspaceID string, lakehouseID string, preview bool, options *LivySessionsClientListLivySessionsPreviewOptions) *runtime.Pager[LivySessionsClientListLivySessionsPreviewResponse] {
	return runtime.NewPager(runtime.PagingHandler[LivySessionsClientListLivySessionsPreviewResponse]{
		...
		Fetcher: func(ctx context.Context, page *LivySessionsClientListLivySessionsPreviewResponse) (LivySessionsClientListLivySessionsPreviewResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "lakehouse.LivySessionsClient.NewListLivySessionsPreviewPager")
			nextLink := ""
			if page != nil {
				nextLink = *page.ContinuationURI
			}
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.listLivySessionsPreviewCreateRequest(ctx, workspaceID, lakehouseID, preview, options)
			}, nil)
			if err != nil {
...
func (client *LivySessionsClient) listLivySessionsPreviewCreateRequest(ctx context.Context, workspaceID string, lakehouseID string, preview bool, options *LivySessionsClientListLivySessionsPreviewOptions) (*policy.Request, error) {
	urlPath := "/v1/workspaces/{workspaceId}/lakehouses/{lakehouseId}/livySessions"
	if workspaceID == "" {
		return nil, errors.New("parameter workspaceID cannot be empty")
	}
...
func (client *LivySessionsClient) ListLivySessionsPreview(ctx context.Context, workspaceID string, lakehouseID string, preview bool, options *LivySessionsClientListLivySessionsPreviewOptions) ([]LivySession, error) {
	pager := client.NewListLivySessionsPreviewPager(workspaceID, lakehouseID, preview, options)
