...
//     method.
func (client *LivySessionsClient) NewListLivySessionsBetaPager(workspaceID string, lakehouseID string, beta bool, options *LivySessionsClientListLivySessionsBetaOptions) *runtime.Pager[LivySessionsClientListLivySessionsBetaResponse] {
	return runtime.NewPager(runtime.PagingHandler[LivySessionsClientListLivySessionsBetaResponse]{
		...
		Fetcher: func(ctx context.Context, page *LivySessionsClientListLivySessionsBetaResponse) (LivySessionsClientListLivySessionsBetaResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "lakehouse.LivySessionsClient.NewListLivySessionsBetaPager")
			nextLink := ""
			if page != nil {
				nextLink = *page.ContinuationURI
			}
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.listLivySessionsBetaCreateRequest(ctx, workspaceID, lakehouseID, beta, options)
			}, nil)
			if err != nil {
...
func (client *LivySessionsClient) listLivySessionsBetaCreateRequest(ctx context.Context, workspaceID string, lakehouseID string, beta bool, options *LivySessionsClientListLivySessionsBetaOptions) (*policy.Request, error) {
	urlPath := "/v1/workspaces/{workspaceId}/lakehouses/{lakehouseId}/livySessions"
	if workspaceID == "" {
		return nil, errors.New("parameter workspaceID cannot be empty")
	}
...
func (client *LivySessionsClient) ListLivySessionsBeta(ctx context.Context, workspaceID string, lakehouseID string, beta bool, options *LivySessionsClientListLivySessionsBetaOptions) ([]LivySession, error) {
	pager := client.NewListLivySessionsBetaPager(workspaceID, lakehouseID, beta, options)
