...
func (l Lakehouse) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "sensitivityLabel", l.SensitivityLabel)
...
func (l *Lakehouse) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "sensitivityLabel":
			err = unpopulate(val, "SensitivityLabel", &l.SensitivityLabel)
			delete(rawMsg, key)
		case "tags":
...
func (r *RefreshMaterializedLakeViewsSchedule) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "id":
			...
			delete(rawMsg, key)
		case "owner":
			r.Owner, err = unmarshalPrincipalClassification(val)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", r, err)
...
// MarshalJSON implements the json.Marshaller interface for type UpdateLakehouseDefinitionRequest.
func (u UpdateLakehouseDefinitionRequest) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "definition", u.Definition)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type UpdateLakehouseDefinitionRequest.
func (u *UpdateLakehouseDefinitionRequest) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
