...
func (i *ItemsServerTransport) dispatchDeleteDigitalTwinBuilderFlow(req *http.Request) (*http.Response, error) {
	...
	var options *digitaltwinbuilderflow.ItemsClientDeleteDigitalTwinBuilderFlowOptions
	if hardDeleteParam != nil {
		options = &digitaltwinbuilderflow.ItemsClientDeleteDigitalTwinBuilderFlowOptions{
			HardDelete: hardDeleteParam,
		}
	}
	respr, errRespr := i.srv.DeleteDigitalTwinBuilderFlow(req.Context(), workspaceIDParam, digitalTwinBuilderFlowIDParam, options)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
...
func (i *ItemsServerTransport) dispatchBeginGetDigitalTwinBuilderFlowDefinition(req *http.Request) (*http.Response, error) {
	...
	if beginGetDigitalTwinBuilderFlowDefinition == nil {
		...
		var options *digitaltwinbuilderflow.ItemsClientBeginGetDigitalTwinBuilderFlowDefinitionOptions
		if formatParam != nil {
			options = &digitaltwinbuilderflow.ItemsClientBeginGetDigitalTwinBuilderFlowDefinitionOptions{
				Format: formatParam,
			}
		}
		respr, errRespr := i.srv.BeginGetDigitalTwinBuilderFlowDefinition(req.Context(), workspaceIDParam, digitalTwinBuilderFlowIDParam, options)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
