...
func (testsuite *FakeTestSuite) SetupSuite() {
	...
	testsuite.clientFactory, err = mlexperiment.NewClientFactory(testsuite.cred, nil, &fabric.ClientOptions{
...
func (testsuite *FakeTestSuite) TestItems_ListMLExperiments() {
	...
	pager := client.NewListMLExperimentsPager(exampleWorkspaceID, &mlexperiment.ItemsClientListMLExperimentsOptions{Recursive: nil,
		RootFolderID:      nil,
