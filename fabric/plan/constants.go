...
// DefinitionFormat - The format of the plan definition. Additional formats may be added over time.
type DefinitionFormat string

const (
	// DefinitionFormatPlanV1 - The format for plan definitions, designed to support CI/CD scenarios in Fabric. See [Plan - PlanV1
	// specification](/rest/api/fabric/articles/item-management/definitions/plan-definition) for more details.
	DefinitionFormatPlanV1 DefinitionFormat = "PlanV1"
)

// PossiblePlanDefinitionFormatValues returns the possible values for the DefinitionFormat const type.
func PossiblePlanDefinitionFormatValues() []DefinitionFormat {
	return []DefinitionFormat{
		DefinitionFormatPlanV1,
	}
}
