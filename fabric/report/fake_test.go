...
func (testsuite *FakeTestSuite) SetupSuite() {
	...
	testsuite.clientFactory, err = report.NewClientFactory(testsuite.cred, nil, &fabric.ClientOptions{
...
func (testsuite *FakeTestSuite) TestItems_ListReports() {
	...
	pager := client.NewListReportsPager(exampleWorkspaceID, &report.ItemsClientListReportsOptions{Recursive: nil,
		RootFolderID:      nil,
