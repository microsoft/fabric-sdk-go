...
// ServerFactoryTransport connects instances of report.ClientFactory to instances of ServerFactory.
...
// The returned ServerFactoryTransport instance is connected to an instance of report.ClientFactory via the
