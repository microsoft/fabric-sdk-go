...
// ServerFactory is a fake server for instances of the databuildtooljob.ClientFactory type.
type ServerFactory struct {
	BackgroundJobsServer BackgroundJobsServer
	ItemsServer          ItemsServer
}

// ServerFactoryTransport connects instances of databuildtooljob.ClientFactory to instances of ServerFactory.
...
// The returned ServerFactoryTransport instance is connected to an instance of databuildtooljob.ClientFactory via the
