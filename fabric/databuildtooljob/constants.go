...
// DefinitionFormat - The format of the DataBuildToolJob definition. Additional formats may be added over time.
type DefinitionFormat string

const (
	// DefinitionFormatDataBuildToolJobV1 - The format for DataBuildToolJob definitions, designed to support CI/CD scenarios in
	// Fabric. See [DataBuildToolJob - DataBuildToolJobV1 specification](/rest/api/fabric/articles/item-management/definitions/data-build-tool-job-definition)
	// for more details.
	DefinitionFormatDataBuildToolJobV1 DefinitionFormat = "DataBuildToolJobV1"
)

// PossibleDataBuildToolJobDefinitionFormatValues returns the possible values for the DefinitionFormat const type.
func PossibleDataBuildToolJobDefinitionFormatValues() []DefinitionFormat {
	return []DefinitionFormat{
		DefinitionFormatDataBuildToolJobV1,
	}
}
