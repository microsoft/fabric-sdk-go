...
const (
	// DefinitionFormatAnomalyDetectorV1 - Format for the AnomalyDetector definition, specifically designed to support CI/CD scenarios
	// in Fabric. see [AnomalyDetector - AnomalyDetectorV1 specification](/rest/api/fabric/articles/item-management/definitions/anomalydetector-definition)
	// for more details.
	DefinitionFormatAnomalyDetectorV1 DefinitionFormat = "AnomalyDetectorV1"
)

// PossibleAnomalyDetectorDefinitionFormatValues returns the possible values for the DefinitionFormat const type.
func PossibleAnomalyDetectorDefinitionFormatValues() []DefinitionFormat {
	return []DefinitionFormat{
		DefinitionFormatAnomalyDetectorV1,
	}
}
