...
// Generated from example definition
func ExampleItemsClient_DeleteKQLQueryset_deleteAKqlQuerysetExample() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	_, err = clientFactory.NewItemsClient().DeleteKQLQueryset(ctx, "cfafbeb1-8037-4d0c-896e-a46fb27ff229", "5b218778-e7a5-4d73-8187-f10824047715", &kqlqueryset.ItemsClientDeleteKQLQuerysetOptions{HardDelete: nil})
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
}
...
// Generated from example definition
func ExampleItemsClient_DeleteKQLQueryset_hardDeleteAKqlQuerysetExample() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	_, err = clientFactory.NewItemsClient().DeleteKQLQueryset(ctx, "cfafbeb1-8037-4d0c-896e-a46fb27ff229", "5b218778-e7a5-4d73-8187-f10824047715", &kqlqueryset.ItemsClientDeleteKQLQuerysetOptions{HardDelete: to.Ptr(true)})
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
}
