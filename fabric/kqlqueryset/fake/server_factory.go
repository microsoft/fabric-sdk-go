...
// ServerFactoryTransport connects instances of kqlqueryset.ClientFactory to instances of ServerFactory.
...
// The returned ServerFactoryTransport instance is connected to an instance of kqlqueryset.ClientFactory via the
