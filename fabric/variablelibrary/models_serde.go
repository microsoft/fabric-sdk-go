...
func (v VariableLibrary) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "defaultIdentity", v.DefaultIdentity)
	...
	populate(objectMap, "sensitivityLabel", v.SensitivityLabel)
...
func (v *VariableLibrary) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "defaultIdentity":
			v.DefaultIdentity, err = unmarshalPrincipalClassification(val)
			delete(rawMsg, key)
		case "description":
		...
		case "sensitivityLabel":
			err = unpopulate(val, "SensitivityLabel", &v.SensitivityLabel)
			delete(rawMsg, key)
		case "tags":
